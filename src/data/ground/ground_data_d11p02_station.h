...
static const struct ScriptCommand s_gs202_g1_s0_lives0_dlg0[] = { /* 0x8255f00 */
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Let~27s storm our way to the\ntop this time~2c $n0!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" But we were very close!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Let~27s be sure to reach the\npeak this time~2c $n0!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
