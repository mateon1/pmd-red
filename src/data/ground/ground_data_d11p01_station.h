...
static const struct ScriptCommand s_gs201_g1_s0_lives0_dlg0[] = { /* 0x8252548 */
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n2 appeared to\nyou...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" So that~27s why you were\nlooking so stunned.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" ...Oh.\nSo something like that happened.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" $n2 appeared to\nyou...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" That~27s why you were\nlooking so stunned earlier.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" But~2c wow...\n$n3 isn~27t just a legend.\nIt really exists...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" I~27m amazed~2c though...\n$n3 isn~27t just a legend.\nIt really exists...") },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" And that $n3 is\nat the peak way up there.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" And that $n3 is up\nat the peak...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Sniffle...#W\n$n0!") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" All the effort we put into\ngetting here...\nIt~27s finally going to pay off!") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" We~27ll meet $n3\nand get the truth!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Sniffle...#W\n$n0!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" All the effort we put into\ngetting here...\nIt~27s finally going to bear fruit!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" We~27ll meet $n3\nand get the truth!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0001,  0x00000001,  0x00000000, NULL },
    { 0xd8, 0x00, -0x0001,  0x00000001,  0x00000026, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" We~27ll finally clear your\nreputation~2c $n0!#W\nThat~27ll be great!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" We~27ll finally get rid of the\nsuspicions others have about you~2c\n$n0!#W Awesome!") },
    { 0xd9, 0x00,  0x0002,  0x00000000,  0x00000000, _("........................") },
    { 0xd9, 0x00,  0x0002,  0x00000000,  0x00000000, _("........................") },
  LABEL(2), /* = 0x02 */
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" You don~27t need to look so\nworried.#W\nIt~27ll be OK.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n0~2c I can\nunderstand how it~27d be scary for you to\nmeet $n3.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" The heartless human who\nabandoned $n2...#W\nHow that might be you...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I bet you~27re scared~2c\nthinking that.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Listen~2c $n0...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" ...Don~27t be so worried.#W\nIt will be all right.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" It~27s only natural that you\nwould be scared of meeting $n3~2c\n$n0.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" The heartless human who\nabandoned $n2...#W\nIt may be you...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" I can understand how\nyou could think that.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xd5, 0x00, -0x0001,  0x00000001,  0x00000000, _(" But that~27s impossible.\nYou~27re not that human--I~27m sure.") },
    { 0xd9, 0x00,  0x0004,  0x00000000,  0x00000000, _("How can you say that?") },
    { 0xd9, 0x00,  0x0004,  0x00000000,  0x00000000, _("You believe so much in me?") },
  LABEL(4), /* = 0x04 */
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" But it doesn~27t matter now.#W\n$n0~2c you~27re a really good sort.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" You know~2c before...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" When I first got the idea\nto start this rescue team...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I met you in the Tiny\nWoods~2c $n0.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Now that I think about it~2c\nthere was something different about you.\nJust a feeling.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" But it doesn~27t matter.\nI know you~27re a good sort~2c $n0...") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Do you remember...?") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" When I first got the idea to\nstart a rescue team...") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" I met you in the Tiny\nWoods~2c $n0...") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Even back then~2c I sensed\nthere was something different about you.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" But it~27s all right.#W\n$n0~2c you~27re a really good sort.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" You know~2c before...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" When I first got the idea\nto start a rescue team...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" I met you in the Tiny\nWoods~2c $n0.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Now that I think about it~2c\nthere was something different about you.") },
    { 0x2e, 0x15,  0x0001,  0x00000001,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" This is kind of weird~2c\nisn~27t it?#W\nBut I believe in you~2c $n0.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" It is weird~2c isn~27t it?#W\nBut I believe in you~2c $n0.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" It is strange~2c isn~27t it?#W\nBut~2c $n0~2c I believe in you.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs201_g2_s1_lives0_dlg0[] = { /* 0x8253910 */
  ...
  LABEL(2), /* = 0x02 */
    ...
    { 0xd9, 0x00,  0x0005,  0x00000000,  0x00000000, _("Mt. Freeze.") },
    { 0xd9, 0x00,  0x0006,  0x00000000,  0x00000000, _("Snow Path.") },
    JUMP_LOCAL(/* label */ 3),
  LABEL(5), /* = 0x05 */
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" All right!\nLet~27s roll out!") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" We want the peak.\nLet~27s give it our best!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" OK!\nLet~27s go!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Let~27s do our best to reach\nthe peak!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs201_g3_s0_lives0_dlg0[] = { /* 0x82541ac */
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Darn...#W\nThat didn~27t go well.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Ouch...#W\nThat turned out badly.") },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" This is one seriously\nrough neighborhood...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" But let~27s storm our way\nto the peak~2c $n0!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" This is a seriously tough\nchallenge~2c but...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Let~27s be sure to reach the\npeak~2c $n0!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x9b, 0x00,  0x0100,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    RET,
