...
static const struct ScriptCommand s_gs171_g5_s0_lives0_dlg0[] = { /* 0x8221f00 */
  ...
  LABEL(10), /* = 0x0a */
    ...
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" We did it~2c $n0!#W\nWe got it done!")),
    VARIANT(/* == */  1, _(" We~27ve won peace!")),
    VARIANT_DEFAULT(_(" We did it~2c $n0!#W\nEverything worked!")),
    VARIANT_DEFAULT(_(" We~27ve won peace!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(30),
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    HALT,
...
static const struct ScriptCommand s_gs171_g6_s0_lives0_dlg0[] = { /* 0x8223d40 */
    ...
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" Wait~2c $n0......")),
    VARIANT_DEFAULT(_(" Don~27t go~2c $n0......")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0014,  0x00000000,  0x00000000, NULL },
    WAIT(60),
