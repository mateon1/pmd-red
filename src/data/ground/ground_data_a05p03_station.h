...
static const struct ScriptCommand s_gs177_g0_s0_station_sref_script[] = { /* 0x822bde8 */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x000000b1,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs177_g1_s0_station_sref_script[] = { /* 0x822be60 */
    ...
    { 0x39, 0x00,  0x001e,  0x00000000,  0x00000000, _("#+But $t isn~27t done yet!\n#+There are many rescues to be done!") },
    ...
    { 0x39, 0x00,  0x001e,  0x00000000,  0x00000000, _("#+Don~27t go away!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
