...
static const struct ScriptCommand s_gs175_g0_s0_station_sref_script[] = { /* 0x822af80 */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x000000af,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs175_g1_s0_eff1_script[] = { /* 0x822b0f4 */
    ...
    { 0x44, 0x00,  0x0000,  0x0000002c,  0x00000000, NULL },
    { 0xdb, 0x00,  0x012c,  0x00000000,  0x00000000, NULL },
    ...
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("(I~27m rising into the sky...)") },
    { 0x2b, 0x00,  0x0000, -0x000000be,  0x0000003c, NULL },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("(Is this my spirit...?)") },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("(I wonder where I~27m going?)") },
...
static const struct ScriptCommand s_gs175_g2_s0_station_sref_script[] = { /* 0x822b2f4 */
    ...
    { 0xdb, 0x00,  0x00aa,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs175_g2_s0_eff1_script[] = { /* 0x822b3d0 */
    ...
    { 0xdb, 0x00,  0x0078,  0x00000000,  0x00000000, NULL },
    { 0x44, 0x00,  0x0000,  0x0000002d,  0x00000000, NULL },
    { 0xdb, 0x00,  0x003c,  0x00000000,  0x00000000, NULL },
