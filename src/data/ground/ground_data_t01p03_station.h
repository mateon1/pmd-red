...
static const struct ScriptCommand s_gs4_g0_s0_station_sref_script[] = { /* 0x8189968 */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x00000004,  0x00000000, NULL },
    ...
    { 0xcd, 0x04,  0x0007,  0x0000000f,  0x00000000, NULL },
    { 0xcd, 0x02,  0x0008,  0x0000000f,  0x00000000, NULL },
    { 0xcd, 0x02,  0x0009,  0x00000010,  0x00000000, NULL },
    { 0xcd, 0x04,  0x000a,  0x00000012,  0x00000000, NULL },
    { 0xcd, 0x02,  0x000b,  0x00000012,  0x00000000, NULL },
    JUMP_LABEL(12),
  LABEL(1), /* = 0x01 */
    { 0xc5, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0xcd, 0x06,  0x000d,  0x00000003,  0x00000000, NULL },
    JUMP_LABEL(14),
  LABEL(13), /* = 0x0d */
  ...
  LABEL(2), /* = 0x02 */
    { 0xc5, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0xcd, 0x06,  0x000f,  0x00000001,  0x00000000, NULL },
    { 0xcd, 0x06,  0x0010,  0x00000004,  0x00000000, NULL },
  ...
  LABEL(0), /* = 0x00 */
    ...
    { 0xcc, 0x00,  0x001d,  0x00000005,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs4_g1_s0_station_sref_script[] = { /* 0x818a8a8 */
    ...
    { 0xb6, 0x00,  0x0000,  0x0000004a,  0x00000001, NULL },
    JUMP_LABEL(1),
  LABEL(0), /* = 0x00 */
...
static const struct ScriptCommand s_gs4_g1_s0_lives2_dlg2[] = { /* 0x818aa20 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" But we~27re actually only\nNormal Rank.#W\nIt~27s an embarrassment...") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs4_g1_s0_lives3_dlg2[] = { /* 0x818ab0c */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0xbd, 0x00,  0x0000,  0x00000076,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Darlings~2c did you know?") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Every so often~2c there are\nrescue jobs that reward you with a new\nFriend Area...") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Well~2c lately there~27ve been\nrumors about a new Friend Area!#W\nThe #CHSky Blue Plains#R~2c they say!") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Just maybe~2c getting that\nFriend Area could be the start of\nsomething enchanting.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Darlings~2c if you spot rescue\njobs that seem promising~2c you should\ntry them!") },
    JUMP_SCRIPT(END_TALK),
  LABEL(0), /* = 0x00 */
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Darlings~2c I~27ll have you know\nthat my #C5Team Constrictor#R is actually\nSilver Rank.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Not too bad~2c is it?#W\nWe surprise people with our excellence.") },
    JUMP_SCRIPT(END_TALK),
};

static const struct ScriptCommand s_gs4_g1_s0_lives4_dlg0[] = { /* 0x818ae1c */
    DEBUGINFO,
    { 0xb8, 0x00,  0x000a,  0x00000031,  0x00000002, NULL },
    { 0xba, 0x00,  0x000a,  0x00000031, -0x00000001, NULL },
    { 0xb8, 0x01,  0x000a,  0x00000031,  0x00000004, NULL },
    { 0xb7, 0x04,  0x0001,  0x00000040,  0x0000000b, NULL },
  LABEL(0), /* = 0x00 */
...
static const struct ScriptCommand s_gs4_g1_s0_lives4_dlg2[] = { /* 0x818aecc */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0xb6, 0x00,  0x0000,  0x0000004a,  0x00000002, NULL },
...
static const struct ScriptCommand s_gs4_g1_s0_lives4_dlg3[] = { /* 0x818b4d4 */
    ...
    { 0xb6, 0x00,  0x0001,  0x0000004a,  0x00000002, NULL },
    { 0x3b, 0x35,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xcc, 0x00,  0x0001,  0x00000001,  0x00000000, NULL },
    { 0xcc, 0x00,  0x0002,  0x00000002,  0x00000000, NULL },
  LABEL(1), /* = 0x01 */
...
static const struct ScriptCommand s_gs4_g1_s1_lives0_dlg0[] = { /* 0x818b710 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" (Papa still hasn~27t come\nhome...)") },
    ...
    WAIT(120),
    { 0x4d, 0x00,  0x0000,  0x000001c5,  0x00000000, NULL },
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Our son~2c we~27re sorry for\ncausing you anxiety.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" That~27s why you were gone...#W\nPapa~2c did you see all the Pokémon that\naren~27t known in these areas?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Oh! Of course!#W\nPapa~2c you~27re so special!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x9b, 0x00,  0x0100,  0x00000000,  0x00000000, NULL },
    { 0xa8, 0x00,  0x004a,  0x00000001,  0x00000001, NULL },
...
static const struct ScriptCommand s_gs4_g2_s0_station_sref_script[] = { /* 0x818c858 */
    ...
    RET_DIRECT,
  LABEL(0), /* = 0x00 */
    { 0xb9, 0x01,  0x000c,  0x00000035,  0x00000001, NULL },
    { 0xb9, 0x02,  0x000c,  0x00000035,  0x00000002, NULL },
    { 0xb9, 0x03,  0x000b,  0x00000033,  0x00000007, NULL },
    { 0xb9, 0x03,  0x000b,  0x00000033,  0x00000008, NULL },
    RET_DIRECT,
  LABEL(3), /* = 0x03 */
    { 0x0c, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    RET_DIRECT,
  LABEL(1), /* = 0x01 */
    { 0x0c, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    RET_DIRECT,
  LABEL(2), /* = 0x02 */
...
static const struct ScriptCommand s_gs4_g3_s0_lives0_dlg0[] = { /* 0x818ca80 */
    ...
    { 0x91, 0x04,  0x0001,  0x00000003,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" We don~27t know why they\nrampage around...") },
...
static const struct ScriptCommand s_gs4_g4_s0_lives0_dlg2[] = { /* 0x818d588 */
  ...
  LABEL(1), /* = 0x01 */
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x1b, 0x00,  0x0108,  0x00000000,  0x00000000, NULL },
    { 0x11, 0x00,  0x0004,  0x00000000,  0x00000000, NULL },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs4_g5_s0_lives0_dlg0[] = { /* 0x818d758 */
    ...
    { 0x2e, 0x03,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" ~93Smeargle~27s desperate plea~2c~93\nhuh...?#W\nThat~27s some title.")),
    VARIANT(/* == */  1, _(" What~27s it say?#W\nCan you read it?")),
    VARIANT_DEFAULT(_(" ~93Smeargle~27s desperate plea~2c~94\nhuh...?#W\nThat~27s quite the title.")),
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(20),
    { 0x35, 0x00, -0x0001,  0x00000000,  0x00000000, _("~93Please allow me to introduce myself.\nMy name is Smeargle.") },
    { 0x35, 0x00, -0x0001,  0x00000000,  0x00000000, _("I once had aspirations of becoming\nan artist.") },
    { 0x35, 0x00, -0x0001,  0x00000000,  0x00000000, _("Then~2c one day...#W\nThere was an incident of an unforgivable\nnature...") },
    { 0x35, 0x00, -0x0001,  0x00000000,  0x00000000, _("I fled because I didn~27t want to become an\nadult.#W\nBut then I lost my way...") },
    { 0x35, 0x00, -0x0001,  0x00000000,  0x00000000, _("I now find myself in this forest~2c unable to\nextricate myself...") },
    { 0x35, 0x00, -0x0001,  0x00000000,  0x00000000, _("I am lost in the #CDHowling Forest#R!#W\nSomebody!#W Please save me!~94") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(20),
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x93, 0x04,  0x000a,  0x00000022,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" .............#W\nIt says he ran away because he didn~27t want\nto be an adult...#W What~27s up with that?")),
    VARIANT(/* == */  1, _(" I don~27t really get it~2c but...#W\nWell~2c let~27s go rescue this Smeargle!")),
    VARIANT_DEFAULT(_(" .............#W\nHe ran away because he didn~27t want to\nbecome an adult...#W What~27s that about?")),
    VARIANT_DEFAULT(_(" I don~27t really get this...#W\nBut let~27s go rescue this Smeargle anyway!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(30),
...
static const struct ScriptCommand s_gs4_g6_s0_lives0_dlg2[] = { /* 0x818e0a4 */
    ...
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh~2c no...\nMedicham went down...\nWhat should I do...?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" If I went~2c I~27d only last a\nlittle while... Oh~2c no...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x0d, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs4_g7_s0_lives0_dlg0[] = { /* 0x818e464 */
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(20),
    { 0x35, 0x00, -0x0001,  0x00000000,  0x00000000, _("~93My name is Medicham.") },
    { 0x35, 0x00, -0x0001,  0x00000000,  0x00000000, _("We had no trouble entering this dungeon...#W\nBut it~27s horrible here!\nIt is much too difficult!") },
    { 0x35, 0x00, -0x0001,  0x00000000,  0x00000000, _("Ekans~2c he was defeated right away.\nIt makes me want to scream!") },
...
static const struct ScriptCommand s_gs4_g9_s0_lives0_dlg0[] = { /* 0x818eafc */
    ...
    ASK3(FALSE, /*default*/ -1, /* speaker */ 2, _(" Say~2c sweetie.#W\nHave you seen Gengar around?")),
  ...
  LABEL(3), /* = 0x03 */
    ...
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" He won~27t do anything wicked\nwith us anymore...") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" I wonder what~27s wrong with\nhim?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x93, 0x04,  0x000a,  0x0000005c,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" No~2c it~27s different.#W\nI can tell.") },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" The way he sets his mouth.\nIt~27s different just a little at the corners.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x93, 0x04,  0x000a,  0x0000005d,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Anyway~2c without Gengar\naround~2c #C5Team Meanies#R can~27t operate.") },
...
static const struct ScriptCommand s_gs4_g10_s0_lives0_dlg2[] = { /* 0x818f4f4 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Anyway~2c without Gengar\naround~2c #C5Team Meanies#R can~27t operate.") },
...
static const struct ScriptCommand s_gs4_g11_s0_station_sref_script[] = { /* 0x818f5c4 */
  ...
  LABEL(2), /* = 0x02 */
    ...
    JUMP_LABEL(3),
  LABEL(3), /* = 0x03 */
    { 0xb3, 0x04,  0x001d,  0x00000000,  0x00000000, NULL },
    { 0x0c, 0x01, -0x0001,  0x00000000,  0x00000000, NULL },
    JUMP_LABEL(5),
  LABEL(4), /* = 0x04 */
    { 0x0c, 0x02, -0x0001,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs4_g12_s0_station_sref_script[] = { /* 0x818faf0 */
    ...
    { 0x08, 0x00,  0x0000,  0x00000004,  0x00000000, NULL },
    { 0x0c, 0xff, -0x0001,  0x00000000,  0x00000000, NULL },
    { 0x12, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x44, 0x00,  0x0000,  0x00000007,  0x00000000, NULL },
    { 0x22, 0x01,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x10, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x0d, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xaf, 0x01,  0x000d,  0x00000000,  0x00000000, NULL },
    RET,
};
...
static const struct ScriptCommand s_gs4_g12_s0_lives0_dlg0[] = { /* 0x818fcdc */
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" See?\nThere were jobs listed~2c right?")),
    VARIANT(/* == */  1, _(" If you want to go on a\nrescue~2c you first choose the job by\nselecting it with #C6Accept#R...")),
    VARIANT(/* == */  1, _(" Then~2c on the #C5Job List#R~2c\nchoose the job~2c then confirm it with\n#C6Take Job#R to go on that rescue mission.")),
    VARIANT(/* == */  1, _(" If you don~27t select #C6Take Job#R~2c\nyou won~27t be able to do the rescue job even\nif you go to the dungeon.")),
    VARIANT(/* == */  1, _(" For the time being~2c we\nshould just stick with the jobs posted\nhere.")),
    VARIANT(/* == */  1, _(" Our team~27ll become known\nafter we do some rescue jobs.")),
    VARIANT(/* == */  1, _(" I bet we~27ll get job offers\nin our Mailbox soon.")),
    VARIANT(/* == */  3, _(" See?\nThere were jobs listed~2c right?")),
    VARIANT(/* == */  3, _(" If you want to do a rescue\njob~2c you first select it with #C6Accept#R...")),
    VARIANT(/* == */  3, _(" Then~2c on the #C5Job List#R~2c\nchoose the job~2c then confirm it with\n#C6Take Job#R to go on that rescue mission.")),
    VARIANT(/* == */  3, _(" If you don~27t select #C6Take Job#R~2c\nyou can~27t do that rescue job even if you go\nto the dungeon. Be careful!")),
    VARIANT(/* == */  3, _(" While we~27re starting out~2c\nwe should handle the jobs that are posted\nhere.")),
    VARIANT(/* == */  3, _(" Doing that should get our\nteam some recognition.")),
    VARIANT(/* == */  3, _(" That should pull in job\noffers to our Mailbox soon.")),
    VARIANT_DEFAULT(_(" See?\nThere were jobs listed~2c right?")),
    VARIANT_DEFAULT(_(" To do a rescue job~2c you first\nselect it with #C6Accept#R...")),
    VARIANT_DEFAULT(_(" Then~2c on the #C5Job List#R~2c\nchoose the job~2c then confirm it with\n#C6Take Job#R to go on that rescue mission.")),
    VARIANT_DEFAULT(_(" If you don~27t select #C6Take Job#R~2c\nyou can~27t do that rescue job even if you go\nto the dungeon.")),
    VARIANT_DEFAULT(_(" Since we~27re just starting up~2c\nwe should handle the jobs that are posted\nhere.")),
...
static const struct ScriptCommand s_gs4_g16_s1_lives0_dlg0[] = { /* 0x8190fcc */
    ...
    WAIT(1),
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" What do you think~2c our son?\nIsn~27t the sea vast?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Yes~2c Papa.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Papa?#W\nPapa~2c have you ever gone out to sea?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs4_g18_s0_station_sref_script[] = { /* 0x81918cc */
    DEBUGINFO,
    { 0xb8, 0x00,  0x0003,  0x00000009,  0x00000004, NULL },
    { 0x0c, 0xff, -0x0001,  0x00000000,  0x00000000, NULL },
    JUMP_LABEL(1),
  LABEL(0), /* = 0x00 */
    { 0x0c, 0xff, -0x0001,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs4_g18_s0_lives0_dlg2[] = { /* 0x8191968 */
    ...
    { 0x2d, 0x09,  0x0003,  0x00000044,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" ............Papa said they~27ve\ngone to sea before...") },
    ...
    CHOICE(/* label */  1, _("No.")),
  LABEL(0), /* = 0x00 */
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Oh.\nSo you can swim too~2c $n0...") },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" OK!\nI~27m going to try hard to swim too!") },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    JUMP_SCRIPT(END_TALK),
  LABEL(1), /* = 0x01 */
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Oh.\nSo you can~27t swim either~2c $n0...") },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" But that~27s natural.\nSwimming isn~27t very easy.") },
...
static const struct ScriptCommand s_gs4_g18_s1_lives0_dlg2[] = { /* 0x8191d1c */
    ...
    CHOICE(/* label */  1, _("No.")),
  LABEL(0), /* = 0x00 */
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh~2c you already knew?#W\nThat~27s OK~2c then.") },
    JUMP_SCRIPT(END_TALK),
  LABEL(1), /* = 0x01 */
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" If you choose jobs in the\nsame dungeon on the #C5Job List#R~2c you can\ndo them at the same time.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" For example~2c say there are\ntwo rescue jobs in the same dungeon~2c but\none on 5F and one on 10F.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" You can accept these two\njobs~2c then select #C6Take Job#R on both of them\nbefore heading into that dungeon.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" You can complete the first\nrescue on 5F. Then~2c instead of exiting~2c\ngo on to the job on 10F.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" That way~2c you can do two\nrescue jobs in one outing.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" See?#W If you do that~2c you\ncan take care of rescue jobs efficiently.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" ...Ehe~2c this is what Alakazam\ntold me.#W I just repeated what he said~2c\nso don~27t tell anyone else.") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs4_g19_s1_lives0_dlg0[] = { /* 0x81922f8 */
    ...
    { 0x2d, 0x09,  0x0003,  0x00000044,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" What do you think~2c Son?\nIsn~27t the sea wonderful?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Yes~2c Papa.") },
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Papa?#W\nPapa~2c can you swim?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs4_g20_s1_lives1_dlg0[] = { /* 0x81929a0 */
    ...
    { 0x2d, 0x09,  0x0003,  0x00000044,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Well~2c Son~2c doesn~27t it feel\ngood to look out over the sea?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Yes~2c Papa.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Papa?#W\nPapa~2c how do you swim in the sea?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" ..................#W\nWell~2c Son...#W\nThe three of us cooperate~2c and...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x2b, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2b, 0x00,  0x0000, -0x00000001, -0x00000001, NULL },
    { 0x2e, 0x02,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" ...And that~27s sort of how\nwe swim!#W\nGasp~2c gasp...") },
...
static const struct ScriptCommand s_gs4_g21_s1_lives0_dlg0[] = { /* 0x8193870 */
    ...
    { 0x2d, 0x09,  0x0003,  0x00000044,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Well~2c our son!\nTell me~2c do the earthquakes frighten you?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Yes~2c Papa.#W\nThey are very scary.") },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Especially when I~27m\nburrowing. It makes me twitchy because\nI get so scared.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Papa?#W\nPapa~2c aren~27t you afraid of earthquakes?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" ........................#W\nOf course they don~27t scare us.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" What do you...#W\nTake us for?!") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" If we were in charge...#W\nThis is what we~27d do to any earthquake!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x2b, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2b, 0x00,  0x0000, -0x00000001, -0x00000001, NULL },
    { 0x2e, 0x02,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Gasp~2c gasp...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" OK!#W\nPapa~2c you~27re so special!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs4_g22_s0_station_sref_script[] = { /* 0x81945bc */
    DEBUGINFO,
    { 0x0c, 0x00, -0x0001,  0x00000000,  0x00000000, NULL },
    { 0xb6, 0x00,  0x0000,  0x0000004a,  0x00000000, NULL },
    JUMP_LABEL(1),
  LABEL(0), /* = 0x00 */
    { 0x0c, 0x02, -0x0001,  0x00000000,  0x00000000, NULL },
  LABEL(1), /* = 0x01 */
...
static const struct ScriptCommand s_gs4_g22_s1_lives0_dlg0[] = { /* 0x81947b4 */
    ...
    { 0x2d, 0x09,  0x0003,  0x00000044,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Well~2c my son?\nDoes Groudon frighten you?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Yes~2c Papa.#W\nIt frightens me so much I don~27t know\nwhat to think.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Papa?#W\nAre you going to the #CDMagma Cavern#R too~2c\nPapa?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" ........................#W\nOf course.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" What do you take us for?!") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" If we were in charge...#W\nThis is what we~27d do to the #CDMagma\nCavern#R!#W Hah!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(30),
    ...
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" ........................") },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" ....................................#WHuh?#W\nPapa?#W Where did you go~2c Papa?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(30),
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xa8, 0x00,  0x004a,  0x00000000,  0x00000001, NULL },
    { 0x9b, 0x00,  0x0100,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x52, 0x00,  0x0000,  0x00001000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs4_g23_s0_lives0_dlg2[] = { /* 0x8194fac */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Papa hasn~27t come back...#W\nI wonder where they went?") },
    { 0x4c, 0x00,  0x0000,  0x000001d1,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh!#W Maybe they~27ve already\ngone to the #CDMagma Cavern#R...") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" And maybe they~27re already\nfighting Groudon.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" And~2c maybe~2c maybe...#W\nMaybe they~27ve already won.#W\nMaybe they~27ve already beaten Groudon!") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh~2c wow! That~27s amazing!#W\nMaybe Papa is special!") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs4_g24_s0_lives0_dlg2[] = { /* 0x81952bc */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Papa hasn~27t come back yet...\nI wonder what happened to them?") },
    { 0x4c, 0x00,  0x0000,  0x000001d1,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh!#W\nMaybe they~27ve already gone to the sky...") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" And maybe they~27ve already\nmet Rayquaza...") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" ...That~27s not possible.\nEven Papa can~27t fly.") },
...
static const struct ScriptCommand s_gs4_g24_s0_lives1_dlg2[] = { /* 0x8195504 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" If that shooting star\ncrashes~2c it~27s going to be terrible!") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" You~27re our only hope!\nGo for it!") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs4_g24_s0_lives2_dlg2[] = { /* 0x81955d8 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh my~2c isn~27t this awful!") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" But I get the feeling that\nyou can make a difference~2c $n0!\nPlease don~27t let us down!") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs4_g25_s0_lives1_dlg2[] = { /* 0x81958a0 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" You~27re going~2c aren~27t you?\nGo for it!") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs4_g25_s0_lives2_dlg2[] = { /* 0x819592c */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh my~2c it~27s time to go?") },
...
static const struct ScriptCommand s_gs4_g26_s0_lives1_dlg2[] = { /* 0x8195bac */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" You~27ll get it done next time!\nGo for it!") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs4_g28_s0_lives0_dlg2[] = { /* 0x8195e54 */
    ...
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" But Papa still hasn~27t come\nback...") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Everyone says they haven~27t\nseen them...#W\nWhere did my papa go?") },
    { 0x4c, 0x00,  0x0000,  0x000001d1,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh!#W\nMaybe they got left behind in the sky...") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" And maybe Rayquaza is\nhaving them as a meal...") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" ......#WThat~27s not possible.#W\nPapa can~27t fly in the first place.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Sigh...\nWhere did Papa go...?") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs4_g28_s0_lives1_dlg2[] = { /* 0x819614c */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh~2c how marvelous~2c\n$n0!") },
...
static const struct ScriptCommand s_gs4_g28_s0_lives2_dlg2[] = { /* 0x8196210 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Seriously~2c consider teaming\nup with me! Gahahaha!") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs4_g28_s0_lives3_dlg2[] = { /* 0x81962d8 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh~2c darlings~2c you~27ve outdone\nyourselves~2c $n0!") },
    JUMP_SCRIPT(END_TALK),
};
...
static const struct ScriptCommand s_gs4_g29_s0_station_sref_script[] = { /* 0x8196438 */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x00000004,  0x00000000, NULL },
    { 0x11, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x0c, 0xff, -0x0001,  0x00000000,  0x00000000, NULL },
