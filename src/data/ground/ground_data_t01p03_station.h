...
static const struct ScriptCommand s_gs4_g0_s0_station_sref_script[] = { /* 0x8189968 */
  ...
  LABEL(1), /* = 0x01 */
    ...
    JUMP_LOCAL(/* label */ 14),
  LABEL(13), /* = 0x0d */
    JUMP_SCRIPT(/* EVENT_M01E02B_L003 */ 133),
  LABEL(14), /* = 0x0e */
...
static const struct ScriptCommand s_gs4_g3_s0_lives0_dlg0[] = { /* 0x818ca80 */
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hmm... That is a problem.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Oh~2c no... That is a problem.") },
    { 0x91, 0x04,  0x0001,  0x00000002,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n0~2c we should go.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" $n0~2c we should go.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs4_g4_s0_lives0_dlg2[] = { /* 0x818d588 */
    ...
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xd5, 0x01,  0x0000, -0x00000001,  0x00000000, _("Activate sub-scenario 1-2\n~93Team Flag~94?") },
    { 0xd9, 0x00,  0x0001,  0x00000000,  0x00000000, _("Activate.") },
    { 0xd9, 0x00,  0x0002,  0x00000000,  0x00000000, _("*Cancel.") },
  LABEL(2), /* = 0x02 */
    JUMP_SCRIPT(/* END_TALK */ 0),
  LABEL(1), /* = 0x01 */
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs4_g5_s0_lives0_dlg0[] = { /* 0x818d758 */
    ...
    { 0x2e, 0x03,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" ~93Smeargle~27s desperate plea~2c~93\nhuh...?#W\nThat~27s some title.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" What~27s it say?#W\nCan you read it?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" ~93Smeargle~27s desperate plea~2c~94\nhuh...?#W\nThat~27s quite the title.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" What does it say?#W\nCan you read it?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0014,  0x00000000,  0x00000000, NULL },
    { 0x91, 0x04,  0x000a,  0x00000004,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs4_g9_s0_lives0_dlg0[] = { /* 0x818eafc */
    ...
    { 0xd5, 0x00, -0x0001,  0x00000002,  0x00000000, _(" Say~2c sweetie.#W\nHave you seen Gengar around?") },
...
static const struct ScriptCommand s_gs4_g12_s0_lives0_dlg0[] = { /* 0x818fcdc */
    ...
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Over there... The\n#C5Pelipper Post Office#R.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" That building is the\n#C5Pelipper Post Office#R.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0004,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x03,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" This is where information\nis gathered from Pokémon needing rescue\nin all sorts of places.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" This is where information\nis gathered from Pokémon needing rescue\nin various locations.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x91, 0x04,  0x000a,  0x00000004,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Take a look at this!\nSee this Bulletin Board?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" See?\nHave a look at this Bulletin Board.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" See?\nThere were jobs listed~2c right?") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" If you want to go on a\nrescue~2c you first choose the job by\nselecting it with #C6Accept#R...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Then~2c on the #C5Job List#R~2c\nchoose the job~2c then confirm it with\n#C6Take Job#R to go on that rescue mission.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" If you don~27t select #C6Take Job#R~2c\nyou won~27t be able to do the rescue job even\nif you go to the dungeon.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" For the time being~2c we\nshould just stick with the jobs posted\nhere.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Our team~27ll become known\nafter we do some rescue jobs.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I bet we~27ll get job offers\nin our Mailbox soon.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" See?\nThere were jobs listed~2c right?") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" If you want to do a rescue\njob~2c you first select it with #C6Accept#R...") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Then~2c on the #C5Job List#R~2c\nchoose the job~2c then confirm it with\n#C6Take Job#R to go on that rescue mission.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" If you don~27t select #C6Take Job#R~2c\nyou can~27t do that rescue job even if you go\nto the dungeon. Be careful!") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" While we~27re starting out~2c\nwe should handle the jobs that are posted\nhere.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Doing that should get our\nteam some recognition.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" That should pull in job\noffers to our Mailbox soon.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" See?\nThere were jobs listed~2c right?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" To do a rescue job~2c you first\nselect it with #C6Accept#R...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Then~2c on the #C5Job List#R~2c\nchoose the job~2c then confirm it with\n#C6Take Job#R to go on that rescue mission.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" If you don~27t select #C6Take Job#R~2c\nyou can~27t do that rescue job even if you go\nto the dungeon.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Since we~27re just starting up~2c\nwe should handle the jobs that are posted\nhere.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Our team name will get\nbetter known by doing that.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" I think that will bring\njob offers to our Mailbox.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" And if you want to take on\na rescue job...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Choose the job on the #C5Job\nList#R...#W Then~2c select #C6Take Job#R.#W\nGet in the habit of doing that regularly!") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" And if you want to go on\na rescue mission...") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Choose the job on the #C5Job\nList#R...#W Then~2c select #C6Take Job#R.#W\nDon~27t forget to do that before you leave!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" And if you want to go on\na rescue mission...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Choose the job on the #C5Job\nList#R...#W Then~2c select #C6Take Job#R.#W\nTry to always do that before you leave!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x9b, 0x00,  0x0100,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x52, 0x00,  0x0000,  0x00001000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs4_g18_s0_lives0_dlg2[] = { /* 0x8191968 */
    ...
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xd5, 0x01, -0x0001,  0x00000003,  0x00000000, _(" $n0.#W\n$n0~2c can you swim?") },
...
static const struct ScriptCommand s_gs4_g18_s1_lives0_dlg2[] = { /* 0x8191d1c */
    ...
    { 0xd5, 0x01, -0x0001,  0x00000001,  0x00000000, _(" You can do several rescue\njobs at the same time.\nDid you know that?") },
    { 0xd9, 0x00,  0x0000,  0x00000000,  0x00000000, _("Yes.") },
    { 0xd9, 0x00,  0x0001,  0x00000000,  0x00000000, _("No.") },
  LABEL(0), /* = 0x00 */
