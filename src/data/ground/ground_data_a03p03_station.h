...
static const struct ScriptCommand s_gs170_g1_s0_lives0_dlg0[] = { /* 0x821d2f8 */
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Brr... It~27s too cold!#W\nThere~27s only snow around us now.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" The scenery hasn~27t changed\nat all for a while now...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Are we even getting\nsomewhere?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Brr... This is too cold!#W\nThere~27s nothing but snow now.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" The scenery~27s been\nthe same for a while...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" I wonder if we~27re really\nmaking progress...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I think we~27ve finally reached\na place where there~27s no one else but us.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I also have this feeling\nthere~27s nothing ahead of us here...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" And~2c I~27m feeling pretty\nbeat...") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" ...Um~2c $n0?\nI was thinking...") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" It looks like we~27ve finally\nreached somewhere that~27s deserted...") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" I also have a feeling that\nthere isn~27t anything ahead...") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" And~2c I am pretty tired...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" ...Hey~2c $n0?\nI was thinking...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" I think we~27ve come to\na place that~27s empty except for us...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" I have this feeling there~27s\nnothing ahead of here~2c even if we keep\nmoving...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" And I~27m getting exhausted...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0001,  0x00000005,  0x00000000, NULL },
    { 0xd8, 0x01, -0x0001,  0x00000001,  0x00000026, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" We two...\nWhat~27s going to happen to us?") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" The two of us...\nWhat~27s going to happen to us?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" We two...\nWhat~27s going to happen to us?") },
    { 0xd9, 0x00,  0x0003,  0x00000000,  0x00000000, _("Don~27t worry. We~27ll be fine!") },
    { 0xd9, 0x00,  0x0004,  0x00000000,  0x00000000, _("I don~27t know...") },
  LABEL(3), /* = 0x03 */
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" We came out here.\nThere~27s no point wondering about it.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Sorry~2c $n0.#W\nI got to feeling sorry for myself.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n0~2c I came out\nhere because I believed in you.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" And that~27s not changing.\nI~27ll keep believing in you~2c $n0...") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" ............#W\nYou~27re right.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" There isn~27t any point in\nwondering about what we did.\nNot after all this.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Sorry~2c $n0.#W\nI was just getting down on myself.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" $n0~2c I believed in\nyou~2c and that~27s what got me this far.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" And that~27s not changing.\nI have faith in you~2c $n0...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" ............#W\nSure~2c that~27s right.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" There isn~27t any point in\nwondering about what might happen.\nNot after coming this far.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Sorry~2c $n0.#W\nI was just feeling sorry for myself.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" I have faith in you~2c \n$n0.\nThat~27s what brought me here.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" And that~27s not changing.\nI still have faith in you~2c $n0...") },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0001,  0x00000001,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27ll go wherever you go.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" I~27ll go with you~2c always.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" I~27ll keep going wherever\nyou go.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    JUMP_LOCAL(/* label */ 5),
  LABEL(4), /* = 0x04 */
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2f, 0x00,  0x0001,  0x00000000,  0x00000002, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" .........#WSorry.#W\nI shouldn~27t have said that.\nIt doesn~27t help scaring you like that.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" We came out here.\nThere~27s no point wondering about it.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Even if we don~27t know\nwhat~27s ahead...#W\nWe just have to keep going.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Don~27t worry!\nThere~27s got to be something ahead.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n0~2c I came out\nhere because I believed in you.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" And that~27s not changing.\nI~27ll keep believing in you~2c $n0...") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" .........#WI~27m sorry.#W\nI shouldn~27t have said anything to bring\nyou down...") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" There isn~27t any point in\nwondering about what we did.\nNot after all this.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Even though we don~27t know\nwhat~27s ahead...#W\nWe~27ll find out if we keep moving!") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Don~27t worry!\nThere~27s got to be something ahead.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" $n0~2c I believed in\nyou~2c and that~27s what got me this far.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" And that~27s not changing.\nI have faith in you~2c $n0...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" .........#WI~27m sorry.#W\nI said something stupid to frighten you...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" There isn~27t any point in\nwondering about what might happen.\nNot after coming this far.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Even though we don~27t know\nwhat~27s ahead...#W\nWe~27ll only know by pressing on!") },
  ...
  LABEL(5), /* = 0x05 */
    ...
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Huh?#W Is something wrong?\n$n0?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000001dc,  0x00000000, NULL },
    { 0x28, 0x01,  0x0007,  0x00000004,  0x00806040, NULL },
    { 0x54, 0x00,  0x0009,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs170_g2_s0_lives0_dlg0[] = { /* 0x821ee64 */
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Talking to yourself like\nthat...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" $n0~2c is something\nthe matter?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Why are you talking to\nyourself?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hey~2c $n0!\nCome on~2c $n0!") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" What were you doing?#W\nWhat just happened to you...?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Hey~2c $n0!\n$n0!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" What~27s the matter?#W\nWhat happened...?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    HALT,
