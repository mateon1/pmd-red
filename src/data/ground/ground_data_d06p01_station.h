...
static const struct ScriptCommand s_gs188_g1_s0_lives0_dlg0[] = { /* 0x82392cc */
    ...
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" But I can~27t be spooked\nby this.")),
    VARIANT(/* == */  1, _(" Our mission is to rescue\n$n4.")),
    VARIANT(/* == */  1, _(" $n0~2c let~27s give it\nour best!")),
    VARIANT(/* == */  3, _(" I shouldn~27t get all scared\nnow!")),
    VARIANT(/* == */  3, _(" Our objective is to rescue\n$n4.")),
    VARIANT(/* == */  3, _(" $n0~2c let~27s do our\nbest!")),
    VARIANT_DEFAULT(_(" I can~27t be scared now.")),
    VARIANT_DEFAULT(_(" Our objective is simple.\nWe~27re rescuing $n4.")),
    VARIANT_DEFAULT(_(" $n0~2c let~27s try\nour best!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs188_g2_s0_lives0_dlg0[] = { /* 0x8239a30 */
    ...
    VARIANT_DEFAULT(_(" Let~27s work hard at it!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x23, 0x00,  0x003c,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    WAIT(15),
