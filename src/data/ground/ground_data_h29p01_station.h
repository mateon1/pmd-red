...
static const struct ScriptCommand s_gs158_g0_s0_station_sref_script[] = { /* 0x820c898 */
  ...
  LABEL(0), /* = 0x00 */
    ...
    { 0xcc, 0x00,  0x0002,  0x00000000,  0x00000000, NULL },
    JUMP_SCRIPT(/* EVENT_S02E02A_L002 */ 279),
  LABEL(4), /* = 0x04 */
...
static const struct ScriptCommand s_gs158_g2_s0_lives0_dlg0[] = { /* 0x820d22c */
    ...
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Fire~2c ice~2c and electricity...") },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Bearing it~2c you will gain\npassage through the sea~27s tornadoes...") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" It will lead you to a place\ncalled the #CDSilver Trench#R.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" There~2c you will find the\nguardian of the sea.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
