...
static const struct ScriptCommand s_gs209_g0_s0_station_sref_script[] = { /* 0x82620a8 */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x000000d1,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs209_g1_s0_station_sref_script[] = { /* 0x8262120 */
    ...
    { 0x4e, 0x00,  0x0010,  0x00000200,  0x00000000, NULL },
    RET,
};
...
static const struct ScriptCommand s_gs209_g1_s0_lives0_dlg0[] = { /* 0x826223c */
    ...
    WAIT(30),
    { 0x4c, 0x00,  0x0000,  0x000001ed,  0x00000000, NULL },
    ...
    { 0x4c, 0x00,  0x0000,  0x00000350,  0x00000000, NULL },
    ...
    WAIT(30),
    { 0x4c, 0x00,  0x0000,  0x00000200,  0x00000000, NULL },
    ...
    VARIANT(/* == */  1, _(" We~27re up on clouds...")),
    VARIANT_DEFAULT(_(" Wh-wh-what?!\nAn earthquake?!#W\nIt~27s not possible!")),
    VARIANT_DEFAULT(_(" We~27re on top of clouds...")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" That~27s it! I get it now!#W\nLook straight up~2c $n2!")),
    VARIANT_DEFAULT(_(" That~27s it! I got it!#W\nLook straight up~2c $n2!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs209_g1_s0_lives4_dlg0[] = { /* 0x8262a4c */
    ...
    { 0x4c, 0x00,  0x0000,  0x0000028c,  0x00000000, NULL },
    { 0x97, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    WAIT(8),
    { 0x97, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000002a0,  0x00000000, NULL },
    ...
    { 0x62, 0x00,  0x0100, -0x00000002,  0x00000000, NULL },
    WAIT(30),
    { 0x4c, 0x00,  0x0000,  0x00000306,  0x00000000, NULL },
    { 0x54, 0x00,  0x0017,  0x00000000,  0x00000000, NULL },
    ...
    { 0xdd, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x00000205,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs209_g2_s0_lives0_dlg0[] = { /* 0x8262f4c */
    ...
    { 0x2e, 0x02,  0x0001,  0x0000000c,  0x00000000, NULL },
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" It~27s a shooting star!\nAnd it~27s gigantic!")),
    VARIANT(/* == */  1, _(" It~27s going to destroy\nthe world if it isn~27t stopped!")),
    VARIANT_DEFAULT(_(" It~27s a shooting star!\nAnd it~27s enormous!")),
    VARIANT_DEFAULT(_(" It will destroy the world\nif it continues on its path!")),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" That~27s why we came~2c\n$n2. We need you to destroy\nthat falling star!")),
    VARIANT(/* == */  3, _(" That~27s why we came~2c\n$n2.\nPlease~2c destroy the falling star!")),
    VARIANT_DEFAULT(_(" That~27s why we came~2c\n$n2.\nPlease~2c destroy the falling star!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    WAIT(15),
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" ...So~2c that is why...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    ...
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x00000201,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0004,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
