...
static const struct ScriptCommand s_gs209_g1_s0_lives0_dlg0[] = { /* 0x826223c */
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Wh-wh-what?! Quake?!#W\nIt can~27t be!") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" We~27re up on clouds...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Wh-wh-what?!\nAn earthquake?!#W\nIt~27s not possible!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" We~27re on top of clouds...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" That~27s it! I get it now!#W\nLook straight up~2c $n2!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" That~27s it! I got it!#W\nLook straight up~2c $n2!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs209_g2_s0_lives0_dlg0[] = { /* 0x8262f4c */
    ...
    { 0x2e, 0x02,  0x0001,  0x0000000c,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" It~27s a shooting star!\nAnd it~27s gigantic!") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" It~27s going to destroy\nthe world if it isn~27t stopped!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" It~27s a shooting star!\nAnd it~27s enormous!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" It will destroy the world\nif it continues on its path!") },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" That~27s why we came~2c\n$n2. We need you to destroy\nthat falling star!") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" That~27s why we came~2c\n$n2.\nPlease~2c destroy the falling star!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" That~27s why we came~2c\n$n2.\nPlease~2c destroy the falling star!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Yes! Hurry!\nDestroy it!") },
    ...
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" So what?!#W\nWe knew that right from the start!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" So?!#W\nWe accepted that from the start!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
