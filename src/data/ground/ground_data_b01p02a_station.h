...
static const struct ScriptCommand s_gs12_g0_s0_station_sref_script[] = { /* 0x81e1954 */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x0000000c,  0x00000000, NULL },
    { 0xc4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0xcd, 0x02,  0x0000,  0x00000003,  0x00000000, NULL },
    { 0xcd, 0x02,  0x0001,  0x00000012,  0x00000000, NULL },
    JUMP_LABEL(2),
  LABEL(0), /* = 0x00 */
  ...
  LABEL(1), /* = 0x01 */
    { 0xc5, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0xcd, 0x06,  0x0004,  0x00000001,  0x00000000, NULL },
    { 0xcd, 0x06,  0x0005,  0x00000002,  0x00000000, NULL },
    JUMP_LABEL(2),
  LABEL(4), /* = 0x04 */
  ...
  LABEL(2), /* = 0x02 */
    ...
    { 0xcc, 0x00,  0x0008,  0x0000000c,  0x00000000, NULL },
    { 0xcc, 0x00,  0x0008,  0x0000000b,  0x00000000, NULL },
    { 0xcc, 0x00,  0x0009,  0x0000000a,  0x00000000, NULL },
    { 0xcc, 0x00,  0x000a,  0x00000009,  0x00000000, NULL },
    JUMP_LABEL(6),
  LABEL(7), /* = 0x07 */
    { 0xc0, 0x00,  0x000f,  0x00000000,  0x00000000, NULL },
    { 0xcc, 0x00,  0x000b,  0x00000009,  0x00000000, NULL },
    { 0xcc, 0x00,  0x000b,  0x0000000a,  0x00000000, NULL },
    { 0xcc, 0x00,  0x000b,  0x0000000b,  0x00000000, NULL },
    { 0xcc, 0x00,  0x0006,  0x0000000c,  0x00000000, NULL },
    { 0xcc, 0x00,  0x0006,  0x0000000d,  0x00000000, NULL },
    { 0xcc, 0x00,  0x0006,  0x0000000e,  0x00000000, NULL },
    JUMP_LABEL(11),
  LABEL(6), /* = 0x06 */
...
static const struct ScriptCommand s_gs12_g0_s0_obj0_dlg2[] = { /* 0x81e1f40 */
    ...
    { 0xcc, 0x00,  0x0002,  0x00000006,  0x00000000, NULL },
    JUMP_SCRIPT(END_TALK),
  LABEL(0), /* = 0x00 */
    { 0xc7, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xcc, 0x00,  0x0003,  0x00000004,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs12_g3_s0_station_sref_script[] = { /* 0x81e24a4 */
    DEBUGINFO,
    { 0xab, 0x00,  0x0006, -0x00000001,  0x00000000, NULL },
    { 0xa6, 0x00,  0x000d,  0x0000000c,  0x00000000, NULL },
    { 0xa6, 0x00,  0x000f,  0x0000000c,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs12_g5_s0_station_sref_script[] = { /* 0x81e27e4 */
    ...
    { 0xa6, 0x00,  0x000f,  0x0000000c,  0x00000000, NULL },
    { 0x08, 0x00,  0x0000,  0x0000000c,  0x00000000, NULL },
    { 0x0c, 0x02,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x10, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x44, 0x00,  0x0000,  0x00000001,  0x00000000, NULL },
    { 0x22, 0x01,  0x001e,  0x00000000,  0x00000000, NULL },
    RET,
...
static const struct ScriptCommand s_gs12_g9_s0_station_sref_script[] = { /* 0x81e2d14 */
    ...
    WAIT(30),
    { 0x12, 0x00,  0x0009,  0x00000000,  0x00000000, NULL },
    { 0x0d, 0x01,  0x0009,  0x00000000,  0x00000000, NULL },
    { 0x22, 0x01,  0x003c,  0x00000000,  0x00000000, NULL },
    { 0xdf, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x44, 0x00,  0x0000,  0x00000001,  0x00000000, NULL },
    RET,
...
static const struct ScriptCommand s_gs12_g9_s0_lives0_dlg0[] = { /* 0x81e2ec0 */
    ...
    VARIANT(/* == */  1, _(" It~27s $n0~27s house.")),
    VARIANT(/* == */  1, _(" It also happens to be our\nrescue team~27s base.")),
    VARIANT(/* == */  3, _(" It~27s $n0~27s house.")),
    VARIANT(/* == */  3, _(" It~27s also our rescue team~27s\nbase.")),
    VARIANT_DEFAULT(_(" It~27s $n0~27s house.")),
    VARIANT_DEFAULT(_(" It~27s also our rescue team~27s\nbase.")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" Hahaha~2c don~27t worry about it.\nNo need for thanks.")),
    VARIANT(/* == */  1, _(" But forget that...#W\nWhat happened to you?")),
    VARIANT_DEFAULT(_(" Hahaha~2c it~27s OK.\nThere~27s no need for thanks.")),
    ...
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Ever since then~2c I~27ve been\ntraveling all over in hopes of seeing\nthe mirage Pokémon...") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" But I~27ve had no luck...#W\nFinally~2c I became dizzy from fatigue...#W\nAnd I must have passed out.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" I...#W\nI~27m giving up on my quest...") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" I~27m simply worn out...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    VARIANT_DEFAULT(_(" Wait a second!#W\nAre you sure you won~27t regret giving up\nthat easily?")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" But I...#W\nI~27ve reached my physical limit...") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" If I push myself any\nfurther~2c I will collapse again.\nIt~27s not good for my health...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" ...Please~2c I want you to\nhave this.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x47, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0x91, 0x04,  0x0001,  0x00000003,  0x00000000, NULL },
    WAIT(30),
    { 0x0f, 0x01,  0x0009,  0x00000000,  0x00000000, NULL },
    WAIT(30),
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x03,  0x0001,  0x00000004,  0x00000000, NULL },
    ...
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0x91, 0x04,  0x0001,  0x00000003,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" It~27s a...#W\n#CIClear Wing#R...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    ...
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" It~27s a wing of some sort.\nIt~27s transparent~2c but...#W\nIf you hold it up like this...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0x14, 0x01,  0x0009,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0x91, 0x04,  0x0002,  0x00000004,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" See? Depending on the light~2c\nit takes on many different colors.") },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0x14, 0x02,  0x0009,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" At first I thought it\nwas just pretty to look at...") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" But after checking around~2c\nit appears to be related to the mirage\nPokémon somehow.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" But I couldn~27t learn anything\nbeyond that.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" ...Sniff...\nIt~27s very disappointing~2c but I~27m giving up...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x03,  0x0001,  0x0000000c,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" Hey~2c are you OK?#W\nYou still look wobbly on your feet.")),
    VARIANT_DEFAULT(_(" Wait~2c are you OK?#W\nYou~27re still unsteady on your feet.")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x02,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Oh~2c no.\nWhen I walk~2c I always totter.#W\nBye.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(20),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    WAIT(30),
    { 0x2e, 0x03,  0x0001,  0x00000004,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" #C4Clear Wing#R~2c huh...#W\nI don~27t have a clue what this is all about...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(10),
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0x91, 0x04,  0x0002,  0x00000001,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs12_g9_s0_lives2_dlg0[] = { /* 0x81e4720 */
    ...
    WAIT(20),
    { 0x4c, 0x00,  0x0000,  0x0000032c,  0x00000000, NULL },
    ...
    { 0x0f, 0x02,  0x0009,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0x54, 0x00,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs12_g11_s0_station_sref_script[] = { /* 0x81e52bc */
    ...
    VARIANT(/* == */  1, _(" ...$n0~2c wake up!\nGet up already!")),
    VARIANT_DEFAULT(_(" ............#W\nHey...")),
    VARIANT_DEFAULT(_(" Hey~2c $n0.")),
    VARIANT_DEFAULT(_(" $n0~2c wake up!\nCome on~2c wake up!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x0c, 0xff, -0x0001,  0x00000000,  0x00000000, NULL },
    { 0x44, 0x00,  0x0000,  0x00000001,  0x00000000, NULL },
    { 0x22, 0x01,  0x003c,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs12_g11_s0_lives0_dlg0[] = { /* 0x81e5528 */
    ...
    CALL_SCRIPT(WAKEUP_FUNC),
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" You~27re finally awake~2c\n$n0?")),
    VARIANT(/* == */  1, _(" Sounds like there~27s a big\nruckus going on at the square.")),
    VARIANT(/* == */  1, _(" Let~27s go check it out!")),
    VARIANT_DEFAULT(_(" $n0~2c are you\nawake?")),
    VARIANT_DEFAULT(_(" There~27s some sort of a\ncommotion down at the square.")),
    VARIANT_DEFAULT(_(" Let~27s take a look!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs12_g12_s0_lives0_dlg0[] = { /* 0x81e5884 */
  ...
  LABEL(2), /* = 0x02 */
    ...
    { 0x2e, 0x15,  0x0001,  0x00000001,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" OK! That~27s settled!")),
  ...
  LABEL(5), /* = 0x05 */
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" All right...\nIt~27s disappointing~2c but that~27s the way\nit goes.")),
    VARIANT_DEFAULT(_(" OK...\nIt~27s disappointing~2c but it can~27t be helped.")),
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" I~27ll go tell $n2 no.")),
    VARIANT_DEFAULT(_(" I~27ll let $n2 know\nhe hasn~27t been accepted.")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    WAIT(30),
...
static const struct ScriptCommand s_gs12_g13_s0_lives0_dlg0[] = { /* 0x81e6580 */
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" Hey~2c $n0!\nGreat news!")),
    VARIANT(/* == */  1, _(" Team #C5$t#R~27s\nrescue rank went up!")),
    VARIANT_DEFAULT(_(" Listen~2c $n0!\nI~27ve got great news!")),
    VARIANT_DEFAULT(_(" Team #C5$t#R~27s\nrescue rank went up!")),
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" I saw Pelipper outside\nlooking dazed~2c so I went and said hello.")),
    VARIANT(/* == */  1, _(" It turns out~2c he was\nsuddenly blown here by gusting winds!")),
    VARIANT_DEFAULT(_(" I saw Pelipper outside\nlooking stunned~2c so I chatted with him.")),
    VARIANT_DEFAULT(_(" Pelipper says he was blown\nhere by a sudden gust of wind!")),
    { 0x2e, 0x15,  0x0001,  0x00000004,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" He doesn~27t seem to have any\nidea why he would even end up here.")),
    VARIANT_DEFAULT(_(" He doesn~27t seem to know\nwhy he would end up here.")),
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" See~2c Pelipper was supposed\nto be making a delivery.")),
    ...
    VARIANT_DEFAULT(_(" He was supposed to take\nthem their new crest showing that\nthey~27d gone up in rescue rank.")),
    { 0x2e, 0x15,  0x0001,  0x00000001,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" But since he ended up here~2c\nhe figures it must be for a good reason.\nWe~27re getting the rescue rank crest!")),
    VARIANT(/* == */  1, _(" Isn~27t that awesome?!#W\nIt~27s kind of unfair~2c but...#W\nWell~2c so what?")),
    VARIANT_DEFAULT(_(" But since he ended up here~2c\nhe thinks it must be for a good reason.\nWe~27re getting that new rescue rank crest!")),
    VARIANT_DEFAULT(_(" It~27s awesome!#W\nI guess it~27s kind of unfair~2c but...#W\nWell~2c anyway!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" I~27ve never said no to a gift!")),
    VARIANT_DEFAULT(_(" If it~27s a gift~2c we have\nto accept!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(15),
    { 0x32, 0x00, -0x0001,  0x00000000,  0x00000000, _("#+Team #C5$t#R~27s\n#+rescue rank went up!") },
...
static const struct ScriptCommand s_gs12_g14_s0_lives0_dlg0[] = { /* 0x81e6fcc */
    ...
    VARIANT(/* == */  1, _(" I don~27t have a clue why\nthey~27d send us this~2c but...")),
    VARIANT(/* == */  1, _(" Who am I to complain?")),
    VARIANT_DEFAULT(_(" Listen~2c $n0!\nI~27ve got great news!")),
    VARIANT_DEFAULT(_(" The Rescue Organization\nsent us some reward money!")),
    VARIANT_DEFAULT(_(" I don~27t have the foggiest\nnotion why they~27d send it...")),
    VARIANT_DEFAULT(_(" But why worry about it?")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" I never turn down\nsomeone~27s generosity!")),
    VARIANT_DEFAULT(_(" If they~27re in a giving mood~2c\nwe shouldn~27t refuse!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(15),
...
static const struct ScriptCommand s_gs12_g15_s0_station_sref_script[] = { /* 0x81e7424 */
    DEBUGINFO,
    { 0xab, 0x00,  0x0000, -0x00000001,  0x00000000, NULL },
    { 0xa6, 0x00,  0x000d,  0x0000000c,  0x00000000, NULL },
    { 0xa6, 0x00,  0x000f,  0x0000000c,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs12_g15_s0_lives0_dlg0[] = { /* 0x81e7560 */
    DEBUGINFO,
    CALL_SCRIPT(INIT_SLEEP_FUNC),
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x2d, 0x09,  0x0001,  0x00000022,  0x00000000, NULL },
    ...
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("...I~27m still the same.") },
...
static const struct ScriptCommand s_gs12_g16_s0_station_sref_script[] = { /* 0x81e77c4 */
    DEBUGINFO,
    { 0x0c, 0xff, -0x0001,  0x00000000,  0x00000000, NULL },
    RET_DIRECT,
};
...
static const struct ScriptCommand s_gs12_g16_s0_evt0_sref_script[] = { /* 0x81e7800 */
    ...
    { 0x54, 0x00,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("Now~2c I only want to sleep...") },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("I~27ll rest in bed...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    RET,
};
...
static const struct ScriptCommand s_gs12_g17_s0_lives0_dlg0[] = { /* 0x81e7be8 */
    ...
    { 0x2e, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("..................") },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("Oof...#W\nI~27m feeling refreshed!") },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("I still look like a Pokémon~2c but...") },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("..................") },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("Oh~2c that~27s right.#W That Pokémon...#W\nI think it was $n1?") },
...
static const struct ScriptCommand s_gs12_g19_s0_lives0_dlg0[] = { /* 0x81e8094 */
    ...
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("But I can~27t quite remember what that\ndream was about...") },
    { 0x2e, 0x15,  0x0000,  0x00000009,  0x00000000, NULL },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("Oh~2c well.\nToday~27s another day of rescues!") },
...
static const struct ScriptCommand s_gs12_g20_s0_lives0_dlg0[] = { /* 0x81e8394 */
    ...
    WAIT(30),
    { 0x34, 0x00, -0x0001,  0x00000000,  0x00000000, _(" ...Oh! You can~27t see us~2c of course!#W\nHow very rude of us!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(30),
    ...
    { 0x34, 0x00, -0x0001,  0x00000000,  0x00000000, _(" We~27re pleased to meet you.\nWe are $n2.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Last night~2c during the\nearthquake...") },
    ...
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" We couldn~27t possibly climb\nsomewhere so high up...") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" That is why we must call\nupon you for your help~2c $n0.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" $n3 was abducted\nby a Pokémon named $n4.") },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" It~27s a vilely vicious ruffian!\nPlease do be careful.") },
    ...
    WAIT(10),
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("............") },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("...That was so sudden~2c there was no time\nto even say no...") },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("It~27s too bad. I~27d better go.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x9b, 0x00,  0x0100,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    RET,
...
static const struct ScriptCommand s_gs12_g33_s0_lives0_dlg0[] = { /* 0x81ea094 */
    ...
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("It~27s the dream I always have~2c but it was\nclearer than it was before...") },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("I think I finally learned who that\nPokémon was...") },
    { 0x4c, 0x00,  0x0000,  0x000001d0,  0x00000000, NULL },
    CALL_SCRIPT(NOTICE_FUNC),
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("That~27s it!#W\n$n2!") },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("It was $n2!") },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("Yesterday~2c $n3 said...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    HALT,
};
...
static const struct ScriptCommand s_gs12_g34_s0_lives0_dlg0[] = { /* 0x81ea3c4 */
    ...
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("Maybe that~27s why I turned into\na Pokémon...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(60),
    { 0x9b, 0x00,  0x0100,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs12_g38_s0_lives0_dlg0[] = { /* 0x81eaddc */
    ...
    CALL_SCRIPT(SHOCK_FUNC),
    { 0x2e, 0x02,  0x0000,  0x0000000c,  0x00000000, NULL },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("Oh~2c wow~2c another earthquake...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(120),
    ...
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _(".......There~27ve been a lot of earthquakes\nlately...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x44, 0x00,  0x0000,  0x00000001,  0x00000000, NULL },
    { 0x9b, 0x00,  0x0100,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs12_g39_s0_lives0_dlg0[] = { /* 0x81eb100 */
    ...
    WAIT(60),
    { 0x2e, 0x15,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("There~27ve been so many quakes lately...") },
    { 0x33, 0x00,  0x0000,  0x00000000,  0x00000000, _("I wonder when they~27ll settle down...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x0c, 0x01, -0x0001,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    WAIT(30),
...
static const struct ScriptCommand s_gs12_g42_s0_station_sref_script[] = { /* 0x81eb8b0 */
    ...
    { 0x27, 0x01,  0x000d,  0x0000003c,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x4e, 0x00,  0x005a,  0x000001e4,  0x00000000, NULL },
    { 0x28, 0x01,  0x000d,  0x0000003c,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs12_g42_s0_lives0_dlg0[] = { /* 0x81eb95c */
    ...
    { 0xdf, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(60),
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" How do you like Dream\nEater?#W\nHorrible~2c isn~27t it? Keke!") },
    { 0x2e, 0x02,  0x0001,  0x00000044,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" But who would~27ve thought\nyou were also human before...#W\nDidn~27t expect that.") },
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" But who cares?\nSomeone like that~27s sure to be some\nlowlife. Keke!") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27ll expose you yet!") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27ll expose what~27s in your\nheart with Dream Eater! Kekeke!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(90),
    { 0x4c, 0x00,  0x0000,  0x000001d0,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs12_g45_s0_station_sref_script[] = { /* 0x81ec1fc */
    ...
    { 0x39, 0x00,  0x001e,  0x00000000,  0x00000000, _("#+Natural disasters still occurred~2c\n#+but much less often.") },
    { 0x39, 0x00,  0x001e,  0x00000000,  0x00000000, _("#+Needless to say~2c\n#+$t~27s rescue activities") },
    ...
    { 0x0c, 0x00,  0x002e,  0x00000000,  0x00000000, NULL },
    RET,
};
...
static const struct ScriptCommand s_gs12_g45_s0_lives0_dlg0[] = { /* 0x81ec59c */
    ...
    VARIANT(/* == */  1, _(" Even though it~27s peaceful\nagain~2c lots of Pokémon still need helping.")),
    VARIANT(/* == */  1, _(" $n0!#W\nLet~27s keep on giving it our best like\nalways!")),
    ...
    VARIANT_DEFAULT(_(" Even though it~27s peaceful\nagain~2c many Pokémon still need our help.")),
    VARIANT_DEFAULT(_(" $n0!#W\nLet~27s keep on doing our best as always!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x9b, 0x00,  0x0100,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs12_g46_s1_lives0_dlg0[] = { /* 0x81ecc04 */
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" Morning~2c $n0!")),
    VARIANT(/* == */  1, _(" Let~27s keep on giving it our\nbest for our rescue team!")),
    VARIANT_DEFAULT(_(" Good morning~2c $n0!")),
    VARIANT_DEFAULT(_(" Let~27s keep doing our best\nfor our rescue team!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x9b, 0x00,  0x0100,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x52, 0x00,  0x0000,  0x00001000,  0x00000000, NULL },
