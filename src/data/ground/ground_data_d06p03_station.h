...
static const struct ScriptCommand s_gs190_g0_s0_station_sref_script[] = { /* 0x823aa14 */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x000000be,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs190_g1_s0_lives0_dlg0[] = { /* 0x823ac18 */
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000001df,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000d,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Enough!#W\nThat~27s enough fighting.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" I~27ve calmed down.\nTake $n6 back.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" You kids...\nYou~27ve impressed me.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" But...#W\nThings won~27t be this easy next time.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" I will go all out next time~2c\nso you~27d best be prepared!") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Until then~2c you~27d better\nhone your skills!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x003c,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000001e1,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0006,  0x00000000,  0x00000000, _(" Ungh... Uh~2c yeah...#W\nSomehow~2c I am...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x03,  0x0001,  0x00000001,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27m glad you~27re safe!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0004,  0x00000000,  0x00000000, _(" You~27re awfully strong for\na plain $m0.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" But you~27re right.\n$n0 isn~27t a Pokémon.") },
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n0 doesn~27t really\nknow what happened~2c either.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n0 just woke up\none morning here as a Pokémon...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" ...And doesn~27t remember\na thing about being a human.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" $n0 doesn~27t\nunderstand very much~2c either.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" $n0 woke up\none morning here as a Pokémon...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" ...And doesn~27t remember\nanything about being a human.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh~2c that~27s right!#W\nLombre was saying something in the\nsquare.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" He said $n3\nknows everything.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n3~2c do you know\nwhy $n0 became a Pokémon?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Oh~2c wait!#W\nLombre said something in the square!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" He said $n3 knows\neverything!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" $n3~2c could you\nfigure out why $n0 became a\nPokémon?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" ......") },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" No...#W\nI can~27t determine that.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh~2c really? How?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Make way to the\n#C5Hill of the Ancients#R.") },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" There~2c you will find a\nPokémon that stares into the sun all day...") },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n0~2c let~27s roll!\nWe~27re going to the #C5Hill of the Ancients#R!") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" There~27s no time to lose!\nWe~27d better go back quick!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" $n0~2c let~27s go!\nOff to the #C5Hill of the Ancients#R!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" We can~27t waste any time!\nLet~27s go back quick!") },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000d,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Shiftry~2c you too.#W\nLet~27s hurry back.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000b,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Don~27t just stand around.\nLet~27s go back.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Don~27t just stand there.\nLet~27s go home.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000d,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0004,  0x00000000,  0x00000000, _(" I don~27t think you~27re \ncompletely ignorant about this.") },
    { 0x34, 0x00,  0x0004,  0x00000000,  0x00000000, _(" ......#W\nYou know something~2c don~27t you?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs190_g1_s0_lives4_dlg0[] = { /* 0x823cc40 */
    ...
    { 0xe4, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000001eb,  0x00000000, NULL },
    ...
    { 0x4d, 0x00,  0x0000,  0x000001eb,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
