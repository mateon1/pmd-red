...
static const struct ScriptCommand s_gs200_g1_s0_lives0_dlg0[] = { /* 0x824fcb4 */
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Please~2c $n2!") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" We have to keep moving.\nWe have to get through this.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Please~2c let us pass!") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Please~2c $n2!") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" We have to get through~2c\nno matter what.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Please~2c let us pass!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Please~2c $n2!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" We have to get through.\nNo matter what it takes.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Please~2c let us pass!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Why?#W\nWhy can~27t we pass?") },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" W-warmed up?\n(I~27m still freezing~2c but...)") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" W-warmed up?\n(I~27m still freezing~2c but...)") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" W-warmed up?\n(I~27m still freezing~2c but...)") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" W-we don~27t have anything\nto do with that!\nIt~27s a coincidence!") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" W-we don~27t have anything\nto do with that!\nIt~27s a coincidence!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" W-we don~27t have anything\nto do with that!\nIt~27s a coincidence!") },
    { 0x2e, 0x15,  0x0001,  0x00000005,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hey~2c $n2.\nYou have to listen.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" It~27s not our fault that the\nsnow is melting here.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" It~27s not just here.#W\nNatural disasters are happening all\nover the place.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Even if we hadn~27t come~2c the\nfrigid air here would have been disturbed.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Please~2c $n2.\nListen to me.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" It~27s not our fault that the\nsnow is melting.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" It~27s not just here.#W\nRight now~2c natural calamities are occurring\neverywhere.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" The forest~27s frigid airflow\nwould have been disturbed even if we\nhadn~27t come.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Please~2c $n2.\nHear me out.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" It isn~27t our fault that the\nsnow started melting here.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" It~27s not just here.#W\nNatural calamities are taking place\neverywhere right now.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" The forest~27s frigid airflow\nwould have been disturbed even if we\nhadn~27t come.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0xd3, 0x00, -0x0001, -0x00000001,  0x00000000, _("Give a nickname to $n3?") },
    { 0xd9, 0x00,  0x001d,  0x00000000,  0x00000000, _("*Yes.") },
    { 0xd9, 0x00,  0x001e,  0x00000000,  0x00000000, _("No.") },
  LABEL(29), /* = 0x1d */
