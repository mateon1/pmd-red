...
static const struct ScriptCommand s_gs183_g1_s0_lives0_dlg0[] = { /* 0x82333ec */
    ...
    VARIANT(/* == */  1, _(" Hey!\nWe sent $n3 packing!")),
    VARIANT(/* == */  1, _(" You~27re safe now.\nCome on down!")),
    VARIANT_DEFAULT(_(" Hey there!\nWe chased $n3 off!")),
    VARIANT_DEFAULT(_(" It~27s OK now.\nCome down over here.")),
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" OK~2c no sweat.#W\nWe~27ll go to you. Just wait.")),
    VARIANT_DEFAULT(_(" OK~2c no problem.#W\nWe~27ll come to you. Just wait.")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x03,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" Hey! It~27s those $n4\nfrom that rescue!")),
