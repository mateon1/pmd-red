...
static const struct ScriptCommand s_gs183_g1_s0_lives0_dlg0[] = { /* 0x82333ec */
    ...
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Grr... I can~27t keep up!#W\nI~27ll flee for now!") },
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" You~27re safe now.\nCome on down!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Hey there!\nWe chased $n3 off!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" It~27s OK now.\nCome down over here.") },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x0f,  0x0002,  0x00000041,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" I can~27t...\nI~27m too scared to move...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" OK~2c no sweat.#W\nWe~27ll go to you. Just wait.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" OK~2c no problem.#W\nWe~27ll come to you. Just wait.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Wow. This is some cliff...\nI can~27t see the bottom.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Sheesh! Look at this cliff...\nI can~27t see the bottom.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0001,  0x00000004,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n0~2c what~27ll\nwe do?\nWe can~27t get across this.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x03,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hey! It~27s those $n4\nfrom that rescue!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Oh~2c hi!\nYou~27re the $n4 we saved!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x0c,  0x0004,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2f, 0x00,  0x0004, -0x00000002,  0x00000000, NULL },
    { 0x34, 0x00,  0x0004,  0x00000000,  0x00000000, _(" DON~27T BE SCARED.\nWE WON~27T MAKE THE MISTAKE OF\nZAPPING YOU. BZBZBZZT!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs183_g1_s1_lives0_dlg0[] = { /* 0x8233eec */
    ...
    { 0x4c, 0x00,  0x0000,  0x000001e3,  0x00000000, NULL },
