...
static const struct ScriptCommand s_gs197_g1_s0_lives0_dlg0[] = { /* 0x82498b0 */
    ...
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" I~27m not lying to you.\nBelieve me.")),
    VARIANT(/* == */  1, _(" If you think I~27m lying...#W\nLook at my eyes!")),
    VARIANT(/* == */  3, _(" It~27s true!\nPlease believe me!")),
    VARIANT(/* == */  3, _(" If you think I~27m lying...#W\nPlease~2c look at my eyes!")),
    VARIANT_DEFAULT(_(" It~27s true!\nPlease believe me!")),
    VARIANT_DEFAULT(_(" If you think I~27m lying...#W\nLook at my eyes!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(15),
    ...
    VARIANT(/* == */  1, _(" ...Of course~2c we can~27t get\nto that right away~2c but...")),
    VARIANT_DEFAULT(_(" OK. I promise.")),
    VARIANT_DEFAULT(_(" ...Of course~2c that~27s not\npossible right now~2c but...")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x15,  0x0001,  0x00000002,  0x00000000, NULL },
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" We~27re fugitives~2c so we can~27t\nget to it right away...")),
    VARIANT(/* == */  1, _(" But we~27re a rescue team.")),
    VARIANT(/* == */  1, _(" We~27ll get to the bottom of\nwhat~27s causing the natural disasters.#W\nI promise.")),
    VARIANT(/* == */  3, _(" We~27re being chased~2c so we\ncan~27t get on it right away...")),
    VARIANT(/* == */  3, _(" But we~27re a rescue team.")),
    VARIANT(/* == */  3, _(" We~27ll get to the bottom of\nwhat~27s causing the natural calamities.#W\nI promise.")),
    VARIANT_DEFAULT(_(" We~27re being hunted~2c so we\ncan~27t get to it right away...")),
    VARIANT_DEFAULT(_(" But we~27re a rescue team.")),
    VARIANT_DEFAULT(_(" We~27ll investigate what~27s\nbehind the natural calamities.#W\nI promise.")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(15),
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x15,  0x0001,  0x00000007,  0x00000000, NULL },
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" Awww~2c sheesh~2c that was\nscary!")),
    VARIANT_DEFAULT(_(" Ewwwwwww~2c that was\nscary!")),
    WAIT(10),
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" But I~27m glad $n2\nunderstood us. Really.")),
    VARIANT(/* == */  1, _(" So~2c anyway...#W\nWe should get off Mt. Blaze ourselves.")),
    VARIANT(/* == */  3, _(" But it~27s really great that\n$n2 understood us.")),
    VARIANT(/* == */  3, _(" Anyway...#W\nWe should get off Mt. Blaze~2c too.")),
    VARIANT_DEFAULT(_(" But I~27m glad $n2\nunderstood us. That was key.")),
