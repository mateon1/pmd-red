...
static const struct ScriptCommand s_gs182_g1_s0_lives0_dlg0[] = { /* 0x8232228 */
    ...
    VARIANT(/* == */  1, _(" So~2c this is it...\n#CDMt. Steel#R...")),
    VARIANT(/* == */  1, _(" $n3~27s been taken\nto the peak here...")),
    VARIANT_DEFAULT(_(" Here we are...\n#CDMt. Steel#R...")),
    VARIANT_DEFAULT(_(" So~2c $n3 was\nwhisked to its peak...")),
...
static const struct ScriptCommand s_gs182_g2_s0_lives0_dlg0[] = { /* 0x8232988 */
    ...
    { 0x2e, 0x03,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" We~27ll take another shot at\n#CDMt. Steel#R.")),
    VARIANT(/* == */  1, _(" We~27ll rescue $n3\nno matter what it takes!")),
    VARIANT_DEFAULT(_(" We have to make another\nattempt at #CDMt. Steel#R.")),
    VARIANT_DEFAULT(_(" Whatever it takes~2c\nlet~27s rescue $n3!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(30),
