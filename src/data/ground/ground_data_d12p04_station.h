...
static const struct ScriptCommand s_gs206_g0_s0_station_sref_script[] = { /* 0x825e858 */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x000000ce,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs206_g1_s0_station_sref_script[] = { /* 0x825e8d0 */
    ...
    { 0x39, 0x00,  0x001e,  0x00000000,  0x00000000, _("#+Having calmed $n2~2c\n#+$n0~27s team left the dungeon...") },
    { 0x39, 0x00,  0x001e,  0x00000000,  0x00000000, _("#+And returned to Pokémon Square\n#+together with $n1~27s team.") },
...
static const struct ScriptCommand s_gs206_g1_s0_lives0_dlg0[] = { /* 0x825eb18 */
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x005a,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000001f3,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Look! It~27s $n3!#W\n$n4 and $n5 too!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Are you all right?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Are you OK?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0009,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Yes~2c fine.") },
...
static const struct ScriptCommand s_gs206_g1_s0_lives4_dlg0[] = { /* 0x825f51c */
    ...
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x00000299,  0x00000000, NULL },
