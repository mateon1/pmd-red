...
static const struct ScriptCommand s_gs184_g2_s0_lives0_dlg0[] = { /* 0x8234830 */
    ...
    { 0x2e, 0x03,  0x0001,  0x00000000,  0x00000000, NULL },
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" Let~27s move it~2c $n0!")),
    VARIANT(/* == */  1, _(" Even while we~27re dawdling\nhere~2c $n2~27s team...")),
    VARIANT(/* == */  1, _(" Hurry! Chop~2c chop!")),
    VARIANT(/* == */  3, _(" Let~27s hurry~2c $n0!")),
    VARIANT(/* == */  3, _(" While we~27re stuck\nback here~2c $n2~27s gang will be...")),
    VARIANT(/* == */  3, _(" We have to hurry!")),
    VARIANT_DEFAULT(_(" Let~27s hustle~2c $n0!")),
    VARIANT_DEFAULT(_(" We~27re still stuck back here\nwhile $n2~27s gang is...")),
    VARIANT_DEFAULT(_(" Come on~2c hurry!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0x23, 0x00,  0x003c,  0x00000000,  0x00000000, NULL },
    { 0x53, 0x00,  0x0000,  0x0000001f,  0x00000000, NULL },
