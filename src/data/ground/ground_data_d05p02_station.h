...
static const struct ScriptCommand s_gs187_g0_s0_station_sref_script[] = { /* 0x8237b78 */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x000000bb,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs187_g1_s0_lives0_dlg0[] = { /* 0x8237d1c */
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n2~27s friend is\nsupposed to be around here~2c right?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Isn~27t this the place?\nWhere $n2~27s friend is supposed\nto be?") },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh~2c hey!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000c,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x15,  0x0001,  0x0000000c,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hey! Are you all right?\nGet it together!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Listen! Are you OK?\nSnap out of it!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Wh-what happened?!\nIt~27s pitch-black! I can~27t see!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Wh-what~27s going on?!\nWhy did it turn pitch-black?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" It~27s coming!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000001f6,  0x00000000, NULL },
    ...
    { 0x34, 0x00, -0x0001,  0x00000000,  0x00000000, _(" Move aside~2c you!") },
    ...
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Shi-$n3~27s gone!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x91, 0x04,  0x0002,  0x00000004,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000c,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" So that~27s the legendary\nmonster...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
