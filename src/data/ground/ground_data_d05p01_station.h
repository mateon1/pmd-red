...
static const struct ScriptCommand s_gs186_g1_s0_lives0_dlg0[] = { /* 0x8235ba8 */
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Whew~2c this is some cliff.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Wow! This cliff is steep!") },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" So your friend $n2\nis somewhere deep in this canyon?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Your friend $n2\nis lost deep in this canyon?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hey~2c no problem.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" It~27ll be fine.") },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hah? What~27s up?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Yes? What is it?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" My stomach suddenly started\ncramping up! Owowow...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I think it~27s something I ate\nthis morning...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" It~27s my stomach!\nIt suddenly cramped up! Owowow...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" I think my breakfast was\nspoiled or something...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x02,  0x0001,  0x00000004,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hey~2c $n0~2c you too~2c\nright?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Say~2c $n0~2c you~27re\nfeeling sick too~2c aren~27t you?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xd8, 0x00, -0x0001,  0x00000001,  0x00000026, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n0~2c you have\na stomachache too~2c don~27t you?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" $n0~2c your stomach\nhurts too~2c doesn~27t it?") },
    { 0xd9, 0x00,  0x000c,  0x00000000,  0x00000000, _("It~27s true! It~27s tearing me up!") },
    { 0xd9, 0x00,  0x000d,  0x00000000,  0x00000000, _("Huh? I~27m perfectly fine.") },
  LABEL(12), /* = 0x0c */
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Sorry~2c but we can~27t handle\nthis rescue...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" See...\n$n0 is hurting too.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" I~27m sorry~2c but we won~27t\nbe able to handle this rescue...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
  ...
  LABEL(13), /* = 0x0d */
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" What~27s wrong with you~2c\n$n0?!\nBack me up here!") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" You~27re my partner!\nYou have to catch my drift better!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" What~27s the matter~2c\n$n0?!\nI need you to back me!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" If you~27re my partner~2c you\nneed to read my cues better!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0002,  0x00000041,  0x00000000, NULL },
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Uh~2c yeah...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Owowow...#W\nI guess the cramping settled down...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Uh~2c yes...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Owowow...#W\nI guess the cramping settled down...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
  ...
  LABEL(16), /* = 0x10 */
    ...
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" So~2c this monster.\nWhat is it like?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" So~2c anyway~2c you said there\nmay be a monster.\nWhat is it like?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" We~27ll just have to hope the\nmonster doesn~27t really exist.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" OK...#W\nWell~2c it can~27t be helped.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Let~27s just hope that monster\ndoesn~27t exist.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" OK! Gotcha!") },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x91, 0x04,  0x000b,  0x00000005,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Let~27s roll~2c $n0!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Let~27s get going~2c\n$n0!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
