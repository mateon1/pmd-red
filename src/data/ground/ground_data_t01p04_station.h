...
static const struct ScriptCommand s_gs5_g3_s0_station_sref_script[] = { /* 0x8198178 */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x00000005,  0x00000000, NULL },
    CALL_SCRIPT(/* DISMISSAL_SALLY_MEMBER2_FUNC */ 60),
    { 0xea, 0x00,  0x0001, -0x00000001,  0x00000000, NULL },
    { 0x0c, 0xff, -0x0001,  0x00000000,  0x00000000, NULL },
    { 0x44, 0x00,  0x0000,  0x00000007,  0x00000000, NULL },
    { 0x22, 0x01, -0x0001,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs5_g3_s0_lives0_dlg0[] = { /* 0x8198234 */
    ...
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Oh! Welcome back!#W\nThe rescue...#Wwent badly~2c I see...") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" But that wasn~27t the final\nchance! Don~27t give up!") },
  ...
  LABEL(0), /* = 0x00 */
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Oh! Welcome back!#W\nThe rescue...#Wwent badly~2c I see...") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" I~27m terribly sorry~2c but you\nmay not go on that rescue again...") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Please inform your friend\nthat~2c regrettably~2c the friend rescue\nmission ended in failure.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x52, 0x00,  0x0000,  0x00001000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
