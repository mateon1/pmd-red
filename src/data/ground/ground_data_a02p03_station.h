...
static const struct ScriptCommand s_gs166_g0_s0_station_sref_script[] = { /* 0x8218bbc */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x000000a6,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs166_g1_s0_lives0_dlg0[] = { /* 0x8218cb0 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh~2c no! Look!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x44, 0x00,  0x0000,  0x00000026,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs166_g2_s0_station_sref_script[] = { /* 0x8218f08 */
    ...
    { 0x23, 0x01,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00, -0x0001,  0x00000000,  0x00000000, _(" Look at them go!\nThey~27re running for Mt. Blaze!") },
    { 0x34, 0x00, -0x0001,  0x00000000,  0x00000000, _(" Are they insane?\nMt. Blaze is doomed desolation!") },
    { 0x34, 0x00, -0x0001,  0x00000000,  0x00000000, _(" No one~27s ever come this far\nbefore!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(15),
    { 0x34, 0x00, -0x0001,  0x00000000,  0x00000000, _(" I don~27t wanna go anywhere like that.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(15),
    { 0x34, 0x00, -0x0001,  0x00000000,  0x00000000, _(" It can~27t be helped.\nOnly those brave enough will give chase!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs166_g2_s0_lives0_dlg0[] = { /* 0x821915c */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" It... It~27s a mountain of fire!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(20),
    ...
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" But they~27re catching up to\nus...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(20),
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x15,  0x0001,  0x00000005,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" What~27ll we do~2c\n$n0?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    WAIT(45),
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" There~27s no choice now!") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Let~27s go~2c $n0!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
