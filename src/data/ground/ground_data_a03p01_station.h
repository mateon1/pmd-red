...
static const struct ScriptCommand s_gs168_g1_s0_lives0_dlg0[] = { /* 0x821bbf8 */
    ...
    VARIANT(/* == */  1, _(" That snow~27s deep.")),
    VARIANT(/* == */  1, _(" There haven~27t been any\nPokémon around for a while~2c either.")),
    VARIANT(/* == */  1, _(" Maybe there isn~27t anyone\nelse out here but us.")),
    VARIANT_DEFAULT(_(" ..................")),
    VARIANT_DEFAULT(_(" Isn~27t this one lonely place?")),
    VARIANT_DEFAULT(_(" See how deep the snow is.")),
    VARIANT_DEFAULT(_(" I haven~27t seen any other\nPokémon for a while~2c either.")),
    VARIANT_DEFAULT(_(" Maybe we~27re all alone here.")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x3b, 0x36,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x54, 0x00,  0x0002,  0x00000000,  0x00000000, NULL },
    ...
    VARIANT_DEFAULT(_(" Oh? What~27s the matter?")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x02,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" Well~2c thinking about it\nisn~27t going to help.#W\nLet~27s keep moving.")),
