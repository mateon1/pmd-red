...
static const struct ScriptCommand s_gs193_g1_s0_lives0_dlg0[] = { /* 0x824313c */
    ...
    VARIANT_DEFAULT(_(" But while we were moving~2c\nI couldn~27t help thinking...")),
    ...
    VARIANT(/* == */  1, _(" $n0~2c we have to\nroll.")),
    VARIANT_DEFAULT(_(" Aww~2c no!\nAre they catching up to us?")),
    VARIANT_DEFAULT(_(" $n0~2c we~27d better\ngo.")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
