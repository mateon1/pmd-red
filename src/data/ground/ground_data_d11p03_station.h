...
static const struct ScriptCommand s_gs203_g2_s0_lives0_dlg0[] = { /* 0x8257ee8 */
    ...
    VARIANT_DEFAULT(_(" We~27ve finally arrived.")),
...
static const struct ScriptCommand s_gs203_g3_s0_lives0_dlg0[] = { /* 0x8259658 */
    ...
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" Oh~2c wow~2c awesome!")),
    VARIANT_DEFAULT(_(" Oh~2c wow~2c fantastic!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    WAIT(15),
    { 0x91, 0x04,  0x0002,  0x00000004,  0x00000000, NULL },
    ...
    VARIANT_DEFAULT(_(" Hey~2c you!#W\nYou were wrong!")),
    ...
    WAIT(10),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" It~27d be nice if I could\nbelieve that...")),
    ...
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" Hahaha! Isn~27t this great?\nI was convinced I was right!")),
