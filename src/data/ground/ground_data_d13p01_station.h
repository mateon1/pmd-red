...
static const struct ScriptCommand s_gs207_g0_s0_station_sref_script[] = { /* 0x825ff68 */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x000000cf,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs207_g1_s0_lives0_dlg0[] = { /* 0x826008c */
    ...
    { 0xdb, 0x00,  0x003c,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000001fd,  0x00000000, NULL },
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Ouch...#W\nWhere are we?") },
    ...
    { 0x91, 0x04,  0x000a,  0x00000006,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n0~2c look up there!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs207_g2_s0_lives0_dlg0[] = { /* 0x8260934 */
    ...
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" It must be at the very top...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" That must be where\n$n2 is...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" It~27s at the top of this\ntower...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" That~27s where $n2\nis...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0x91, 0x04,  0x000a,  0x00000006,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs207_g3_s0_lives0_dlg0[] = { /* 0x8260d38 */
    ...
    { 0x91, 0x04,  0x000a,  0x00000006,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Let~27s storm our way to\nthe top floor!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Let~27s head for the top!\nThis is it!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x23, 0x00,  0x0050,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
