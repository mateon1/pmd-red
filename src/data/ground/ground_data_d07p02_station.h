...
static const struct ScriptCommand s_gs192_g2_s0_lives0_dlg0[] = { /* 0x823ef68 */
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Yes! We finally made it to\nthe top~2c $n0!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Yes! We~27ve finally made it\nto the top~2c $n0!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" So this is the #C5Hill of\nthe Ancients#R...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" This is the #C5Hill of the\nAncients#R...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0xd9, 0x00,  0x0002,  0x00000000,  0x00000000, _("Tickle him.") },
    { 0xd9, 0x00,  0x0003,  0x00000000,  0x00000000, _("Attack him.") },
  LABEL(2), /* = 0x02 */
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hah? Tickle him?#W\n...OK. I~27ll try it.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Huh? Tickle him?#W\n...OK. It~27s worth a try.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" It~27s useless~2c $n0.\nI~27m not getting any response.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" It~27s no good~2c $n0.\nHe~27s not responding.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x005a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x03,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" He finally started laughing...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Maybe...#W\nIs he just dense?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" He~27s finally laughing now...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Is he...#W\njust dense?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x005a,  0x00000000,  0x00000000, NULL },
    { 0x47, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
  ...
  LABEL(3), /* = 0x03 */
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" ...#WOh~2c all right. \nYou really want me to do this.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" ...#WFine~2c then.\nI~27ll do it~2c OK?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x03,  0x0001,  0x00000004,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" If something happens to me~2c\npromise you~27ll help me.\nI~27m counting on you.") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" If anything happens to me~2c\nyou have to help me. You have to promise!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" If anything happens\nto me~2c you have to help me.\nI~27m counting on you.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    ...
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" All right. Counting down.#W\nThree...#W Two...#W One...#W Now...!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" OK. Counting down.#W\nThree...#W Two...#W One...#W Now...!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x2b, 0x00,  0x0000, -0x00000001, -0x00000001, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
  ...
  LABEL(4), /* = 0x04 */
    ...
    { 0x2e, 0x03,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Then~2c you~27ve got to tell us~2c\n$n2!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" If you know~2c please tell us~2c\n$n2!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0x91, 0x04,  0x0001,  0x00000002,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" This is my friend\n$n0...") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" My friend woke up one\nmorning as a Pokémon.") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Without remembering\nanything as a human being~2c too.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Next to me is my friend\n$n0...") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" My friend woke up one\nmorning as a Pokémon.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" And~2c without any memory as\na human.") },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0x91, 0x04,  0x0002,  0x00000003,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" $n2~2c you can tell~2c\ncan~27t you?#W\nCan~27t you tell us?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" $n2~2c you can tell~2c\ncan~27t you?#W\nPlease tell us.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" ..................") },
    ...
    { 0x2e, 0x03,  0x0001,  0x00000003,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" What is it?! Hey?!") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Why did you clam up?\nCome on~2c tell us~2c please!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" What is it?!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Why did you clam up?!\nPlease~2c tell us! Please!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0014,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x03,  0x0001,  0x0000000c,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Wh-#Wwhat did you say?") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" The world...#W\nThe unthinkable is going to happen?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Huh...?#W\nYou~27re serious?!") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" The world...#W\nThe unthinkable is coming?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
