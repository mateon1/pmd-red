...
static const struct ScriptCommand s_gs2_g0_s0_station_sref_script[] = { /* 0x817d60c */
    ...
    JUMP_LOCAL(/* label */ 11),
  LABEL(0), /* = 0x00 */
    { 0xea, 0x00,  0x000a, -0x00000001,  0x00000000, NULL },
    JUMP_LOCAL(/* label */ 12),
  LABEL(1), /* = 0x01 */
  ...
  LABEL(14), /* = 0x0e */
    ...
    JUMP_LOCAL(/* label */ 12),
  LABEL(15), /* = 0x0f */
    { 0xea, 0x00,  0x000c, -0x00000001,  0x00000000, NULL },
    JUMP_LOCAL(/* label */ 12),
  LABEL(2), /* = 0x02 */
    { 0xc5, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
  ...
  LABEL(30), /* = 0x1e */
    ...
    { 0xbb, 0x1f,  0x0006,  0x00000000,  0x00000000, NULL },
    JUMP_LOCAL(/* label */ 32),
  LABEL(31), /* = 0x1f */
    { 0x10, 0x02,  0x0000,  0x00000000,  0x00000000, NULL },
  LABEL(32), /* = 0x20 */
...
static const struct ScriptCommand s_gs2_g0_s2_evt0_sref_script[] = { /* 0x817df34 */
    DEBUGINFO,
    { 0xb4, 0x03,  0x0000,  0x00000021,  0x00000001, NULL },
...
static const struct ScriptCommand s_gs2_g1_s0_lives0_dlg2[] = { /* 0x817e130 */
    ...
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" I went into the cave~2c but...#W\nI couldn~27t evolve into Butterfree.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" That~27s too bad~2c Metapod.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" I bet you weren~27t high\nenough in level~2c Metapod.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" If you train and raise your\nlevel~2c I think you~27ll be able to evolve.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Oh~2c so it~27s my level!#W\nI get it! I~27ll work at leveling up!") },
...
static const struct ScriptCommand s_gs2_g2_s0_station_sref_script[] = { /* 0x817e608 */
    ...
    RET_DIRECT,
  LABEL(0), /* = 0x00 */
    { 0xb9, 0x01,  0x0005,  0x00000021,  0x00000003, NULL },
    { 0xb9, 0x02,  0x000b,  0x00000033,  0x00000001, NULL },
    { 0xb9, 0x03,  0x000b,  0x00000033,  0x00000003, NULL },
    { 0xb9, 0x04,  0x000b,  0x00000033,  0x00000005, NULL },
    { 0xb9, 0x04,  0x000b,  0x00000033,  0x00000006, NULL },
    { 0xb8, 0x05,  0x000a,  0x00000031,  0x00000002, NULL },
    { 0xba, 0x05,  0x000a,  0x00000031, -0x00000001, NULL },
    { 0xb8, 0x06,  0x000a,  0x00000031,  0x00000004, NULL },
    { 0xb7, 0x04,  0x0006,  0x00000040,  0x0000000b, NULL },
  LABEL(5), /* = 0x05 */
    RET_DIRECT,
  LABEL(1), /* = 0x01 */
...
static const struct ScriptCommand s_gs2_g3_s0_lives0_dlg2[] = { /* 0x817e834 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xba, 0x00,  0x0005,  0x00000021,  0x00000003, NULL },
    { 0x4c, 0x00,  0x0000,  0x000001d1,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Ah~2c so you wish to know\nabout the dungeon in the sea?") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~2c too~2c have heard of it.") },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" There~2c one will find a\ndungeon that leads to the bottom of\nthe sea.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" The sea is infinitely dark~2c\nand its depth unimaginable.\nThat is what I have heard.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" However...#W\nTo go beneath the sea~2c a Hidden Machine\nnamed #CIDive#R is needed.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Without #CIDive#R~2c you cannot\ngo to the #CDStormy Sea#R.") },
    { 0x2e, 0x15,  0x0001,  0x00000001,  0x00000000, NULL },
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0014,  0x00000000,  0x00000000, NULL },
    { 0x32, 0x00, -0x0001,  0x00000000,  0x00000000, _("#+Beware--you must take the HM #CIDive#R~2c\n#+or a team member must learn #CIDive#R\n#+as a move for the team to enter!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x44, 0x00,  0x0000,  0x00000008,  0x00000000, NULL },
  ...
  LABEL(0), /* = 0x00 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I suppose it wouldn~27t hurt\nto search there.") },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0001,  0x00000001,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hohoho.#W\nAdventures keep you young.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Why~2c if I were only a little\nyounger~2c I might have joined you on your\nadventures.") },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    JUMP_SCRIPT(/* END_TALK */ 0),
    RET,
...
static const struct ScriptCommand s_gs2_g6_s0_lives0_dlg0[] = { /* 0x817f910 */
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" ...We~27ve found it at last!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Hey~2c now~2c don~27t forget about\nmy wish!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x02,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x03,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Listen~2c $n3.#W\nWe must keep this a secret just between\nthe two of us.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" We can~27t tell any Pokémon.\nNot even Gengar.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" I know that!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Let~27s decide on how\nwe~27re going to do this...#W First...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000001d1,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
  ...
  LABEL(3), /* = 0x03 */
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x15, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x9b, 0x00,  0x0100,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs2_g8_s0_lives0_dlg0[] = { /* 0x8180674 */
    ...
    { 0x2e, 0x02,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x03,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" $n3~2c listen.#W\nI~27m thinking it is best if only we go\ninto the dungeon.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" If either one of us\nfalls before the end...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Oh~2c I get it.#W\nThe other one can still go make wishes!") },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" That~27s smart~2c $n2!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0002,  0x00000001,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" But of course.\nI can~27t wait until our wishes\ncome true〜♪") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
  ...
  LABEL(4), /* = 0x04 */
    ...
    { 0x91, 0x08,  0x000a,  0x00000001,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x15, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0x9b, 0x00,  0x0100,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x52, 0x00,  0x0000,  0x00001000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs2_g9_s1_lives0_dlg0[] = { /* 0x818131c */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" ...I got KO~27d in that\ndungeon~2c but what about Medicham?\nHope she~27s OK...") },
    ...
    { 0x2e, 0x15,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" I~27m having a hard time\ntrying to make up my mind!#W\nGet lost!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" ...Hunh? Wait a second...\nMaybe I shouldn~27t be wishing for\na bigger lower jaw...?") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" I wonder if it~27d be better\nif I could coil myself tighter...") },
...
static const struct ScriptCommand s_gs2_g10_s0_lives0_dlg2[] = { /* 0x81818ec */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27ve heard fissures have\nopened up in the ground here and there.\nThey~27re trouble for everyone.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" It worries me to no\nend~2c thinking that children will fall\ndown into them...") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g11_s0_lives0_dlg2[] = { /* 0x8181acc */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27ve lived in this pond for\nmany long years...") },
...
static const struct ScriptCommand s_gs2_g12_s0_lives1_dlg2[] = { /* 0x8181d6c */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27m going to call on\n$n3 and go play in the woods!\nIt~27s going to be fun!") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g13_s0_lives0_dlg2[] = { /* 0x8181f38 */
    ...
    { 0x2d, 0x09,  0x0002,  0x00000036,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27ve not seen $n2\nor other children lately.\nI wonder how they are keeping.") },
...
static const struct ScriptCommand s_gs2_g14_s0_lives0_dlg2[] = { /* 0x81820f0 */
    ...
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0001,  0x00000001,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" It~27s good to see the\nyoungsters back.") },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27m also grateful for what\nyou~27ve done. Thank you.") },
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" In other words~2c it forces\none to enter in a completely clean state.") },
...
static const struct ScriptCommand s_gs2_g15_s0_lives1_dlg2[] = { /* 0x8182768 */
    ...
    { 0x2e, 0x02,  0x0002,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x03,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Yay~2c $n3!\nWhat~27ll we do next?") },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Let~27s play battle!") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" OK~2c I use String Shot!") },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Then~2c I use Harden!") },
...
static const struct ScriptCommand s_gs2_g16_s0_lives0_dlg2[] = { /* 0x8182a70 */
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0xd5, 0x00, -0x0001,  0x00000001,  0x00000000, _(" What was that?\nYou wish to hear the #C4$n2 legend#R?") },
...
static const struct ScriptCommand s_gs2_g16_s1_lives0_dlg0[] = { /* 0x8182f18 */
    ...
    { 0x44, 0x00,  0x0000,  0x00000006,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" There once lived a Pokémon\nby the name of $n2.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Now~2c $n2 had\nmany tails~2c all of them imbued with\npsychic power...") },
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Yes~2c a human.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" As one might expect~2c the\nhuman that grabbed the tail was subjected\nto a thousand-year curse.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" However~2c just when the\ncurse was cast~2c a Pokémon named\n$n4 shielded the human...") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" And sacrificed herself to\nabsorb the curse.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Why?") },
    { 0x34, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Why would that Pokémon~2c\nGardevoir~2c take the human~27s place?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" To $n4~2c that human\nwas her partner.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" There exist strong bonds\nbetween humans and Pokémon.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x03,  0x0003,  0x00000004,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000003,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" ...All right.#W\nBut humans... Aren~27t there good ones and\nbad ones too?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" ...OK.#W\nBut humans... Aren~27t there good humans\nand bad ones too?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Correct.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Taking pity on $n4~2c\n$n2 asked the human this...") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" ~93Do you wish to save\n$n4?~94 it asked...") },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" ~93That human will one day\nbe reborn as a Pokémon...~94") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0008,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" ~93And when the human \nbecomes a Pokémon...~94") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" ~93The world~27s balance will\nbe upset...~94") },
...
static const struct ScriptCommand s_gs2_g16_s1_lives2_dlg2[] = { /* 0x8183d24 */
  ...
  LABEL(2), /* = 0x02 */
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I see.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" If you feel the urge to hear\nmy tale again~2c come see me anytime.\nHohoho.") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g18_s0_lives0_dlg0[] = { /* 0x8183f98 */
    ...
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Yes~2c a human.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" As one might expect~2c the\nhuman that grabbed the tail was subjected\nto a curse of a thousand years.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" However~2c just when the\ncurse was cast~2c a Pokémon named\n$n3 shielded the human...") },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Why would that Pokémon~2c\nGardevoir~2c take the human~27s place?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" To $n3~2c that human\nwas her partner.") },
...
static const struct ScriptCommand s_gs2_g20_s0_lives1_dlg0[] = { /* 0x81844f8 */
    DEBUGINFO,
    { 0xb9, 0x00,  0x0004,  0x0000001e, -0x00000001, NULL },
...
static const struct ScriptCommand s_gs2_g20_s0_lives1_dlg2[] = { /* 0x8184568 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27m so glad $n0\nisn~27t under suspicion anymore.") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g21_s0_lives1_dlg2[] = { /* 0x81848ec */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I was so scared~2c I spat silk\nall over the place...#W\nIt was a mess for everyone...") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g21_s0_lives2_dlg2[] = { /* 0x81849e0 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I couldn~27t take a step...#W\nI was just shaking inside my shell...") },
...
static const struct ScriptCommand s_gs2_g22_s0_lives1_dlg2[] = { /* 0x8184c9c */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27m terrified of all the\nearthquakes...") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g22_s0_lives2_dlg2[] = { /* 0x8184d28 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I haven~27t relaxed from\nhardening at all...") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g23_s0_lives0_dlg2[] = { /* 0x8184e44 */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I shouldn~27t be panicking.#W\nI have the ability to sense quakes.\nI must remain calm.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" It appears I~27ve learned\nsomething from you youngsters.") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g23_s0_lives1_dlg2[] = { /* 0x818502c */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" We~27ll be OK.\nWe~27ll try not to be scared of the quakes!") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g23_s0_lives2_dlg2[] = { /* 0x8185100 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27ll do my best to harden\nmyself!") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g24_s0_lives1_dlg2[] = { /* 0x81853ec */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Mom is weak to fire~2c so it\nisn~27t easy for her...") },
...
static const struct ScriptCommand s_gs2_g24_s0_lives2_dlg2[] = { /* 0x81855b8 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27ve hardened quite a lot!\nNo earthquake can touch me now!") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g25_s0_lives1_dlg2[] = { /* 0x8185874 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I~27ll use Harden and wait for\n$n0~27s team to come back!") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g26_s0_lives2_dlg2[] = { /* 0x8185bac */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hello~2c I am Caterpie~27s\nmother. It~27s been a while.") },
...
static const struct ScriptCommand s_gs2_g27_s0_lives0_dlg2[] = { /* 0x8185d90 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Ah...#W The #CDSky Tower#R~2c\nyou say...") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" In all my long years~2c I~27d\nnot known of any world above the clouds.") },
...
static const struct ScriptCommand s_gs2_g27_s0_lives3_dlg2[] = { /* 0x818601c */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh~2c is that right?\nYou can climb above the clouds?") },
...
static const struct ScriptCommand s_gs2_g29_s0_lives0_dlg0[] = { /* 0x81863ec */
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hi~2c $n4!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0004,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    ...
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Hey~2c $n4?#W\nHave you seen Snubbull around?") },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" I heard something weird\nhappened to him.") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Hi~2c $n4.\nHave you seen Snubbull?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" I heard something strange\nhappened to him.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0005,  0x00000000,  0x00000000, _(" I~27m Snubbull.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000001d1,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" But you don~27t look anything\nlike the way you did before!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0005,  0x00000000,  0x00000000, _(" I don~27t really understand~2c\neither.") },
    { 0x34, 0x00,  0x0005,  0x00000000,  0x00000000, _(" I went into the cave there~2c\nand all of a sudden...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x15,  0x0001,  0x00000004,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Evolution? Evolved?#W\nWhat~27s that about?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Evolution? Evolved?#W\nI don~27t follow.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0004,  0x00000000,  0x00000000, _(" Pokémon~2c upon satisfying\ncertain conditions~2c may evolve.") },
    { 0x34, 0x00,  0x0004,  0x00000000,  0x00000000, _(" When a Pokémon undergoes\nevolution~2c its appearance changes.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000001d1,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0004,  0x00000000,  0x00000000, _(" Perhaps evolution could\nnot take place before because the world~27s\nbalance was askew.") },
    { 0x34, 0x00,  0x0004,  0x00000000,  0x00000000, _(" However~2c now that the star\nhas been destroyed...#W\nThe world~27s balance has been restored...") },
    ...
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" So if I evolved~2c I would\nbecome like $n3?!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x03,  0x0003,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0004,  0x00000000,  0x00000000, _(" Appearance isn~27t the only\nthing that changes through evolution.") },
    { 0x34, 0x00,  0x0004,  0x00000000,  0x00000000, _(" One~27s power and abilities\nmay be enhanced~2c for example.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000001d1,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    ...
    { 0x2e, 0x15,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    { 0xd0, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Can we evolve if we go to\nthat cave?") },
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" Can we evolve if we go to\nthat cave?") },
    { 0xd1, 0x00,  0x0000,  0x00000000,  0x00000000, _(" Can we evolve if we go to\nthat cave?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0009,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0xd0, 0x00,  0x0003,  0x00000000,  0x00000000, _(" $n0.#W\nLet~27s go to the cave if we~27re ready to\nevolve.") },
...
static const struct ScriptCommand s_gs2_g29_s0_lives2_dlg0[] = { /* 0x8187b78 */
    ...
    { 0x91, 0x04,  0x000a,  0x00000003,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    { 0x91, 0x04,  0x000a,  0x00000004,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    CALL_SCRIPT(/* NOTICE_FUNC */ 40),
    { 0xe3, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs2_g30_s0_lives1_dlg2[] = { /* 0x818843c */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" Oh~2c I hope I can be\nButterfree soon...") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
...
static const struct ScriptCommand s_gs2_g30_s0_lives4_dlg2[] = { /* 0x8188644 */
    ...
    { 0x2d, 0x07,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0001,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" That cave~27s entrance\nappears rather narrow.\nOnly one may enter at a time~2c it seems.") },
    { 0x34, 0x00,  0x0001,  0x00000000,  0x00000000, _(" If you wish to enter the\ncave~2c you must come alone.") },
    JUMP_SCRIPT(/* END_TALK */ 0),
};
