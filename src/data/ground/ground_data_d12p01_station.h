...
static const struct ScriptCommand s_gs204_g1_s0_lives0_dlg0[] = { /* 0x825d228 */
    ...
    VARIANT(/* == */  1, _(" Let~27s get in there and give\nit our best!")),
    VARIANT(/* == */  3, _(" Other rescue teams\nshould already be here.")),
    VARIANT(/* == */  3, _(" Let~27s get going and try our\nbest!")),
    VARIANT_DEFAULT(_(" There should be other\nrescue teams making their way through\neven now.")),
    VARIANT_DEFAULT(_(" Let~27s try our best like\nalways!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs204_g2_s0_lives0_dlg0[] = { /* 0x825d818 */
    ...
    WAIT(15),
    { 0xcf, 0x02,  0x0026,  0x00000001,  0x00000000, NULL },
    VARIANT(/* == */  1, _(" This time~2c we~27ll rescue\n$n2~27s team!\nLet~27s get it done!")),
    VARIANT_DEFAULT(_(" This time~2c we have to\nrescue $n2~27s team!\nLet~27s not blow it!")),
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0006,  0x00000000,  0x00000000, NULL },
    { 0x23, 0x00,  0x0050,  0x00000000,  0x00000000, NULL },
    WAIT(15),
