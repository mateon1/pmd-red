...
static const struct ScriptCommand s_gs220_g0_s0_station_sref_script[] = { /* 0x826aa0c */
    DEBUGINFO,
    { 0x08, 0x00,  0x0000,  0x000000dc,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs220_g1_s0_lives0_dlg0[] = { /* 0x826abb0 */
    ...
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Oh~2c look!#W\nThere~27s a dais!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" There~27s a hollow spot.\nI guess that stone goes in there.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x0000015c,  0x00000000, NULL },
    ...
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0002,  0x00000044,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" That~27s odd...\nI could~27ve sworn I heard something...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x003c,  0x00000000,  0x00000000, NULL },
    ...
    { 0x33, 0x00, -0x0001,  0x00000000,  0x00000000, _("#+Just now~2c a key was\n#+inserted to break a curse.") },
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Kekeh? What?#W\nYou~27re going to test me?") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" What~2c I have to fight some\nboss creature?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x33, 0x00, -0x0001,  0x00000000,  0x00000000, _("#+Oh~2c no.\n#+Nothing so barbaric.") },
    ...
    { 0x33, 0x00, -0x0001,  0x00000000,  0x00000000, _("#+$n2~2c you will not\n#+be doing the answering...") },
...
static const struct ScriptCommand s_gs220_g1_s0_lives1_dlg0[] = { /* 0x826be2c */
    ...
    { 0xe3, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x0000026f,  0x00000000, NULL },
...
static const struct ScriptCommand s_gs220_g2_s0_lives0_dlg0[] = { /* 0x826c278 */
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x33, 0x00, -0x0001,  0x00000000,  0x00000000, _("#+It is most regrettable~2c but\n#+the curse on $n3\n#+will last all eternity...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Wait!\nWait a minute!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x0000029a,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x0078,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0x45, 0x00,  0x003c,  0x00000018,  0x00000000, NULL },
    { 0xdb, 0x00,  0x003c,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" It~27s true.\nI abandoned $n3 and ran.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" I was afraid that the curse\nwould fall on me.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" I had to get away~2c no matter\nwhat...#W\nThat~27s what I thought.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" It didn~27t take long for me\nto forget about the curse and about\n$n3.") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0x2e, 0x15,  0x0002,  0x00000044,  0x00000000, NULL },
    ...
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" It~27s not just $n3.") },
    ...
    { 0x4c, 0x00,  0x0000,  0x000002ae,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000f,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000002ae,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000f,  0x00000000,  0x00000000, NULL },
    { 0x4c, 0x00,  0x0000,  0x000002ae,  0x00000000, NULL },
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x45, 0x00,  0x003c,  0x00000005,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0005,  0x00000000,  0x00000000, _(" It worked~2c $n2!") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0x91, 0x04,  0x000a,  0x00000001,  0x00000000, NULL },
    ...
    { 0xe4, 0x00,  0x0007,  0x00000000,  0x00000000, NULL },
    { 0xe3, 0x00,  0x0005,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" Then~2c Gardevoir...?") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    ...
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x000a,  0x00000000,  0x00000000, NULL },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" ............#WThat doesn~27t matter.") },
    { 0x34, 0x00,  0x0002,  0x00000000,  0x00000000, _(" $n3 is back.#W\nThat~27s enough for me...") },
    { 0x30, 0x00,  0x0000,  0x00000000,  0x00000000, NULL },
    { 0xdb, 0x00,  0x001e,  0x00000000,  0x00000000, NULL },
    { 0xe4, 0x00,  0x0003,  0x00000000,  0x00000000, NULL },
    HALT,
